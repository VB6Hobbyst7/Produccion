...
'***************************************************
Public Sub ImpreBegin(pbCondensado As Boolean, nLineas As Integer, Optional ByVal pnImpresora As Impresoras = gEPSON)
    
    'By capi 01102008 para la impresion en IBM
    If pnImpresora = Impresoras.gIBM Then
        ArcSal = FreeFile
