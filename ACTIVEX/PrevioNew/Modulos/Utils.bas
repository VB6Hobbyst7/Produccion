...
Global Const EM_FORMATRANGE As Long = WM_USER + 57
Global Const PHYSICALOFFSETX As Long = 112
Global Const PHYSICALOFFSETY As Long = 113
...
'        For I = 1 To frmCount
'            ChildForms(I).rtfText.MousePointer = 99
'        Next
'
'        ' Saves the Font attributes of the
'        ' selected text to these variables
'        fBold = ChildForms(frm).rtfText.SelBold
'        fItalics = ChildForms(frm).rtfText.SelItalic
'        fUnderline = ChildForms(frm).rtfText.SelUnderline
'        fStrikeThru = ChildForms(frm).rtfText.SelStrikeThru
'        fFont = ChildForms(frm).rtfText.SelFontName
'        fSize = ChildForms(frm).rtfText.SelFontSize
'        fColor = ChildForms(frm).rtfText.SelColor
'
'        ' Makes FPaint 2 ie Ready to Paint the format
'        fPaint = 2
'        ChildForms(frm).rtfText.SelLength = 0
'
'    ElseIf fPaint = 2 Then
'
'        ' Copies the format to the selected text
'        If fBold = True Then
'            ChildForms(frm).rtfText.SelBold = True
'        Else
'            ChildForms(frm).rtfText.SelBold = False
'        End If
'
'        If fItalics = True Then
'            ChildForms(frm).rtfText.SelItalic = True
'        Else
'            ChildForms(frm).rtfText.SelItalic = False
'        End If
'        If fUnderline = True Then
'            ChildForms(frm).rtfText.SelUnderline = True
'        Else
'            ChildForms(frm).rtfText.SelUnderline = False
'        End If
'        If fStrikeThru = True Then
'            ChildForms(frm).rtfText.SelStrikeThru = True
'        Else
'            ChildForms(frm).rtfText.SelStrikeThru = False
'        End If
'
'        ChildForms(frm).rtfText.SelFontName = fFont
'        ChildForms(frm).rtfText.SelFontSize = fSize
'        ChildForms(frm).rtfText.SelColor = fColor
'
...
'        For I = 1 To frmCount
'            ChildForms(I).rtfText.MousePointer = rtfDefault
'        Next
'
'    End If
