...
Begin VB.Form frmPrevio 
   ...
   Begin VB.CommandButton CmdSetup 
      ...
      Width           =   945
   End
   Begin Previo.epCmDlg dlgBPrint 
      Left            =   1635
      Top             =   2685
      _ExtentX        =   661
      _ExtentY        =   635
   ...
   Begin RichTextLib.RichTextBox rtfTexto 
      ...
      MousePointer    =   99
      RightMargin     =   25000
      TextRTF         =   $"frmPrevio.frx":03E7
      MouseIcon       =   "frmPrevio.frx":0467
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Courier New"
         Size            =   8.25
         Charset         =   0
...
Public Sub Previo(ByVal pRTFImpresion As String, vTitulo As String, pbCondensado As Boolean, nLineas As Integer)
...
Private Sub cboPrevio_Click()
    ...
    Case "25%": rtfTexto.SelFontSize = 4
    Case "50%": rtfTexto.SelFontSize = 5
    Case "55%": rtfTexto.SelFontSize = 5.5
    Case "65%": rtfTexto.SelFontSize = 6
    Case "70%": rtfTexto.SelFontSize = 6.5
    Case "75%": rtfTexto.SelFontSize = 7
    Case "100%": rtfTexto.SelFontSize = 7.5
    Case "125%": rtfTexto.SelFontSize = 8.5
    Case "150%": rtfTexto.SelFontSize = 9.5
    Case "175%": rtfTexto.SelFontSize = 11
    Case "200%": rtfTexto.SelFontSize = 12.5
    End Select
    rtfTexto.SelStart = 0
End Sub
...
Else
    ...
    ' Get length of text in rtfTexto
    TextLength = Len(rtfTexto.Text)

    ' Loop printing each page until done
    Do
        ' Print the page by sending EM_FORMATRANGE message
        NextCharPosition = SendMessage(rtfTexto.hwnd, EM_FORMATRANGE, True, fr)
    ...
    ' Allow the rtfTexto to free up memory
    r = SendMessage(rtfTexto.hwnd, EM_FORMATRANGE, False, ByVal CLng(0))
    Exit Sub
...
Private Sub Form_Load()
    ...
    CmdSetup.Move CmdSetup.Left, Me.Height - (1.5 * 567), CmdSetup.Width, CmdSetup.Height
...
Private Function GetCadenaFormateada(psCadena As String, pImpresora As Impresoras) As String
    Dim lsCad As String
