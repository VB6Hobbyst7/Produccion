...
Private Declare Function GetComputerName Lib "kernel32" Alias "GetComputerNameA" (ByVal lpBuffer As String, nSize As Long) As Long 'WIOR 20131009
...
Private Sub CmdAceptar_Click()
    ...
    If ImpreSensa = True Then
        ...
        'By Capi 23102008
        i = InStr(Trim(cboPrinters), "Generic")
        If i <> 0 Then
            gsImpresoraElegida = "Generic"
        End If
        '
...
Private Sub Form_Load()
    ...
    Dim i As Integer
    Dim lResult As Long
    Dim lsImpresora As String 'WIOR 20131009
    ...
    Me.cboCara.AddItem "RICOH" & Space(100) & Impresoras.gRICOH 'RIRO20140905
