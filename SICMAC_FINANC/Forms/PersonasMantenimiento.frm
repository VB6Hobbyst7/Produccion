...
Begin VB.Form frmPersona 
   ...
   Begin TabDlg.SSTab SSTDatosGen 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox cmbPersUbiGeo 
            ...
            Height          =   315
            Index           =   0
            ItemData        =   "PersonasMantenimiento.frx":034A
            Left            =   210
            List            =   "PersonasMantenimiento.frx":034C
            Style           =   2  'Dropdown List
            TabIndex        =   14
            Top             =   525
            Width           =   1815
         ...
         Begin VB.ComboBox cmbPersUbiGeo 
            ...
            Left            =   2250
            List            =   "PersonasMantenimiento.frx":0350
            Style           =   2  'Dropdown List
            TabIndex        =   15
            Top             =   540
            Width           =   2175
         ...
         Begin VB.ComboBox cmbPersUbiGeo 
            ...
            Height          =   315
            Index           =   4
            ItemData        =   "PersonasMantenimiento.frx":0352
            Left            =   4680
            List            =   "PersonasMantenimiento.frx":0354
            Style           =   2  'Dropdown List
            TabIndex        =   18
            Top             =   1155
            Width           =   2430
         ...
         Begin VB.ComboBox cmbPersUbiGeo 
            ...
            Height          =   315
            Index           =   2
            ItemData        =   "PersonasMantenimiento.frx":0356
            Left            =   4680
         ...
         Begin VB.ComboBox cmbPersUbiGeo 
            ...
            Height          =   315
            Index           =   3
            ItemData        =   "PersonasMantenimiento.frx":035A
            Left            =   2235
            List            =   "PersonasMantenimiento.frx":035C
            Style           =   2  'Dropdown List
            TabIndex        =   17
            Top             =   1140
            Width           =   2190
      ...
      Begin VB.ComboBox cmbPersEstado 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "PersonasMantenimiento.frx":035E
         Left            =   -73770
         List            =   "PersonasMantenimiento.frx":0360
         Style           =   2  'Dropdown List
         TabIndex        =   12
         Top             =   3330
         Width           =   2520
   ...
   Begin TabDlg.SSTab SSTabs 
      ...
      TabPicture(0)   =   "PersonasMantenimiento.frx":0362
      ...
      TabPicture(1)   =   "PersonasMantenimiento.frx":037E
      ...
      TabPicture(2)   =   "PersonasMantenimiento.frx":039A
      ...
      TabPicture(3)   =   "PersonasMantenimiento.frx":03B6
      ...
      TabCaption(4)   =   "Fir&ma"
      TabPicture(4)   =   "PersonasMantenimiento.frx":03D2
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "IDBFirma"
      Tab(4).Control(1)=   "CmdActFirma"
      Tab(4).ControlCount=   2
      TabCaption(5)   =   "Ref Comercial"
      TabPicture(5)   =   "PersonasMantenimiento.frx":03EE
      ...
      TabPicture(6)   =   "PersonasMantenimiento.frx":040A
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "feRefBancaria"
      Tab(6).Control(1)=   "cmdRefBanNuevo"
      Tab(6).Control(2)=   "cmdRefBanElimina"
      Tab(6).Control(3)=   "cmdRefBanEdita"
      Tab(6).Control(4)=   "cmdRefBanCancela"
      Tab(6).Control(5)=   "cmdRefBanAcepta"
      Tab(6).ControlCount=   6
      TabCaption(7)   =   "Pat. Vehicular"
      TabPicture(7)   =   "PersonasMantenimiento.frx":0426
      ...
      Begin VB.ComboBox cmbNacionalidad 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "PersonasMantenimiento.frx":0442
         Left            =   5865
         List            =   "PersonasMantenimiento.frx":0444
         Style           =   2  'Dropdown List
         TabIndex        =   89
         Top             =   1875
         Width           =   1560
      ...
      Begin VB.ComboBox CboTipoSangre 
         Height          =   315
         ItemData        =   "PersonasMantenimiento.frx":0446
         Left            =   8730
         List            =   "PersonasMantenimiento.frx":0448
         Style           =   2  'Dropdown List
         TabIndex        =   87
         Top             =   1470
         Width           =   1125
      ...
      Begin VB.ComboBox cmbPersNatSexo 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "PersonasMantenimiento.frx":044A
         Left            =   5850
         List            =   "PersonasMantenimiento.frx":044C
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   645
         Width           =   1545
      ...
      Begin VB.ComboBox cmbPersJurMagnitud 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "PersonasMantenimiento.frx":044E
         Left            =   -68880
         List            =   "PersonasMantenimiento.frx":0450
         Style           =   2  'Dropdown List
         TabIndex        =   30
         Top             =   1305
         Width           =   3000
      ...
      Begin VB.ComboBox cmbPersJurTpo 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "PersonasMantenimiento.frx":0452
         Left            =   -73680
         List            =   "PersonasMantenimiento.frx":0454
         Style           =   2  'Dropdown List
         TabIndex        =   28
         Top             =   1320
         Width           =   3000
      ...
      Begin VB.ComboBox cmbPersNatEstCiv 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "PersonasMantenimiento.frx":0456
         Left            =   5850
         List            =   "PersonasMantenimiento.frx":0458
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   1065
         Width           =   1560
...
Private Sub HabilitaControlesPersona(ByVal pbBloqueo As Boolean)
    ...
    TxtEmail2.Enabled = pbBloqueo 'EJVG20111212
...
Dim I As Integer
    ...
    'LUCV20181220, Anexo01 de Acta 199-2018
    If (nTipoAccion = 3) Then 'Pista para la accion de consulta
        Set objPista = New COMManejador.Pista
        lsMovNro = GetMovNro(gsCodUser, gsCodAge)

        objPista.InsertarPista gsOpeCod, lsMovNro, gsCodPersUser, GetMaquinaUsuario, gConsultar, Me.Caption & " - (Sicmac Financiero) ", TxtBCodPers.Text, gCodigoPersona
...
'Created By GITU 11-07-2013
Public Function CargarUbicacionesGeograficasNew(Optional ByVal pbPaises As Boolean = False, _
...
Dim oConecta As DConecta
    ...
    On Error GoTo ErrorCargarUbicacionesGeograficasNew
    ...
    Set CargarUbicacionesGeograficasNew = oConecta.CargaRecordSet(sSql)
    oConecta.CierraConexion
    Set oConecta = Nothing
    Exit Function
    
ErrorCargarUbicacionesGeograficasNew:
    Set CargarUbicacionesGeograficasNew = Nothing
...
If Index <> 4 Then
    ...
    Set rs = CargarUbicacionesGeograficasNew(True, Index + 1, Trim(Right(cmbPersUbiGeo(Index).Text, 15)))
...
'*********************************************************************
    ...
    If fbPermisoCargo Then
        ...
        If bCabecera Then
            Call oCambio.RegistroCabeceraDatosCambiosDatosPrinc(cMovCambio, oPersona.PersCodigo, 3)
        End If
    End If
    Set rsDocPersActual = Nothing
    Set rsDocPersUlt = Nothing
