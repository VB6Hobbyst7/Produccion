...
Begin VB.Form frmHistoContabMayor 
   Caption         =   "Contabilidad: Libro Mayor-Historico"
   ClientHeight    =   3510
   ClientLeft      =   4575
   ClientTop       =   4005
   ClientWidth     =   6090
   ...
   End
End
Attribute VB_Name = "frmHistoContabMayor"
...
sImpre = oImp.ImprimeLibroMayor(CDate(txtFechaDel), CDate(txtFechaAl), txtAgeCod, txtOpeCod, gnLinPage, , True)
Me.Enabled = True
