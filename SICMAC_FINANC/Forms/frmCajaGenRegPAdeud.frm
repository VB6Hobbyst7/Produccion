...
Begin VB.Form frmCajaGenRegPAdeud 
   ...
   EndProperty
   Icon            =   "frmCajaGenRegPAdeud.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8235
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CheckBox ChkContable 
         ...
         Caption         =   "Generar datos contable"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame fradatosGen 
      ...
      Begin Sicmact.TxtBuscar txtBuscaIF 
         ...
         appearance      =   1
         appearance      =   1
         font            =   "frmCajaGenRegPAdeud.frx":08CA
         appearance      =   1
      End
   ...
   Begin TabDlg.SSTab TabDoc 
      ...
      TabPicture(0)   =   "frmCajaGenRegPAdeud.frx":08EE
      ...
      TabPicture(1)   =   "frmCajaGenRegPAdeud.frx":090A
      ...
      TabPicture(2)   =   "frmCajaGenRegPAdeud.frx":0926
      ...
      Begin Sicmact.FlexEdit fgChqRecibido 
         ...
         font            =   "frmCajaGenRegPAdeud.frx":095E
         font            =   "frmCajaGenRegPAdeud.frx":0982
         font            =   "frmCajaGenRegPAdeud.frx":09A6
         font            =   "frmCajaGenRegPAdeud.frx":09CA
         font            =   "frmCajaGenRegPAdeud.frx":09EE
         fontfixed       =   "frmCajaGenRegPAdeud.frx":0A12
      ...
      Begin Sicmact.FlexEdit fgOtros 
         ...
         font            =   "frmCajaGenRegPAdeud.frx":0A40
         font            =   "frmCajaGenRegPAdeud.frx":0A64
         font            =   "frmCajaGenRegPAdeud.frx":0A88
         font            =   "frmCajaGenRegPAdeud.frx":0AAC
         font            =   "frmCajaGenRegPAdeud.frx":0AD0
         fontfixed       =   "frmCajaGenRegPAdeud.frx":0AF4
      ...
      Begin VB.Frame fraTransferencia 
         ...
         Begin Sicmact.TxtBuscar txtBuscaEntidad 
            ...
            appearance      =   1
            appearance      =   1
            font            =   "frmCajaGenRegPAdeud.frx":0B22
            appearance      =   1
         End
      ...
      Begin Sicmact.FlexEdit fgObj 
         ...
         font            =   "frmCajaGenRegPAdeud.frx":0B46
         font            =   "frmCajaGenRegPAdeud.frx":0B72
         font            =   "frmCajaGenRegPAdeud.frx":0B9E
         font            =   "frmCajaGenRegPAdeud.frx":0BCA
         font            =   "frmCajaGenRegPAdeud.frx":0BF6
         fontfixed       =   "frmCajaGenRegPAdeud.frx":0C22
   ...
   End
End
Attribute VB_Name = "frmCajaGenRegPAdeud"
...
If Trim(txtBuscaIF) <> "" Then
    If cPersCodMivienda = Mid(txtBuscaIF, 4, 13) Then
    Else
        ChkContable.value = 1
    End If
Else
...
If cPersCodMivienda = Mid(txtBuscaIF, 4, 13) Then
    If ChkContable.value = 0 Then
        If MsgBox("Este pagaré se grabará sin registro contable, ¿desea continuar?", vbYesNo + vbQuestion, "Aviso") = vbNo Then
            Exit Sub
        End If
    End If
End If
If MsgBox("Desea Grabar Operación de Apertura??", vbYesNo + vbQuestion, "Aviso") = vbYes Then
    ...
    oCaja.GrabaRegPagareAdeudado lsMovNro, gsOpeCod, txtFecha, txtMovDesc, nVal(txtCapital), frmAdeudCal.txtCapital, _
           Me.txtCuentaCod, txtCuentaDesc, lbCreaSubCta, lsSubCtaIF, lblDescTipoCta, _
            ...
            , Me.txtPorcentAfect.value, lsCtaOrdenD, lsCtaOrdenH, IIf(frmAdeudCal.chkMiVivienda.value = 1, nVal(frmAdeudCal.txtConcesional.Text), 0), IIf(ChkContable.value = 1, 1, 0)
...
If txtBuscaIF <> "" And Val(txtTotApertura) > 0 Then
    ...
    If frmAdeudCal.OK Then
        ...
        'lnPlazo = IIf(frmAdeudCal.txtPlazoCuotas.Text = "0", "30")
    Else
        lbCalendario = False
        Set frmAdeudCal = Nothing
    End If
...
cPersCodMivienda = "1093300012530" 'ALPA20150131
End Sub
...
Dim oDocPago As clsDocPago
    ...
    If optDoc(0).value Then
        oDocPago.InicioCheque "", True, Mid(txtBuscaEntidad, 4, 13), gsOpeCod, gsNomCmac, gsOpeDesc, txtMovDesc, _
                    ...
                    lblDesCtaIfTransf, "", True, , , , Mid(txtBuscaEntidad, 1, 2), Mid(txtBuscaEntidad, 4, 13), Mid(txtBuscaEntidad, 18, 10) 'EJVG20121130
                     'lblDesCtaIfTransf, "", True
...
If KeyAscii = 13 Then
    Me.txtComisionInicial.SetFocus
...
If KeyAscii = 13 Then
   txtComisionMonto = Format(Round(nVal(txtCapital) * IIf(txtComisionInicial = "", 0, txtComisionInicial) / 100, 2), gsFormatoNumeroView)
...
'    txtLinCredCod.SelStart = 0
'    txtLinCredCod.SelLength = 50
End Sub
