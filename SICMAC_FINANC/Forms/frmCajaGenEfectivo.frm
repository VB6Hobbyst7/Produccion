...
Me.lbl3 = lbl3 & gsSimbolo & " :"
Me.Label4 = Label4 & gsSimbolo & " :"
Me.Label5 = Label5 & gsSimbolo & " :"
lblMontoSol.BackColor = IIf(lnMoneda = gMonedaNacional, vbWhite, &HC0FFC0)
...
If lbRegistro = True Then
    ...
    lsOpeCod = gOpeHabBoveRegEfect
    lsMovNro = oCajero.GetMovUserBilletaje(lsOpeCod, gsCodUser, gdFecSis)
