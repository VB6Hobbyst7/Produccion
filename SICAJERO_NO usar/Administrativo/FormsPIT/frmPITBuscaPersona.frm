...
Begin VB.Form frmPITBuscaPersona 
   ...
   ClientTop       =   2535
   ClientWidth     =   7695
   Icon            =   "frmPITBuscaPersona.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmPITBuscaPersona"
...
Private Sub CmdAceptar_Click()
   ...
   Else
        ...
        End If
   End If
   Call Persona.CargaDatos(R!cPersCod, R!cPersNombre, Format(IIf(IsNull(R!dPersNacCreac), gdFecSis, R!dPersNacCreac), "dd/mm/yyyy"), IIf(IsNull(R!cPersDireccDomicilio), "", R!cPersDireccDomicilio), IIf(IsNull(R!cPersTelefono), "", R!cPersTelefono), R!nPersPersoneria, IIf(IsNull(R!cPersIDnroDNI), "", R!cPersIDnroDNI), IIf(IsNull(R!cPersIDnroRUC), "", R!cPersIDnroRUC), IIf(IsNull(R!cPersIDnro), "", R!cPersIDnro), IIf(IsNull(R!cPersNatSexo), "", R!cPersNatSexo))
   Set R = Nothing
