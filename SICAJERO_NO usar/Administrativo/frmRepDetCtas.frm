VERSION 5.00
Begin VB.Form frmRepDetCtas 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Reporte de Detalle de Tarjetas"
   ClientHeight    =   2400
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5145
   Icon            =   "frmRepDetCtas.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRepDetCtas"
...
Dim Cont As Integer
    ...
    '
    'sSql = "Select T.cNumTarjeta, dFecActivacion, ISNULL(P.cPersNombre,'') cPersNombre, "
    'sSql = sSql & " T.cUserActiv , A.cAgeDescripcion, TC.cCtaCod "
    'sSql = sSql & " From Tarjeta T"
    'sSql = sSql & " INNER JOIN  TarjetaCuenta TC ON TC.cNumtarjeta=T.cNumtarjeta"
    ...
    sSQL = " REP_DetCuentas '" & Format(CDate(Me.txtfecIni.Text), "mm/dd/yyyy") & "','" & Format(CDate(Me.txtFecFin.Text), "mm/dd/yyyy") & "','" & Trim(Str(Me.ChkUsu.Value)) & "','" & Trim(Me.TxtUsu.Text) & "','" & Trim(Str(Me.ChkAge.Value)) & "','" & Trim(Me.CboAgencia.Text) & "'"
    
    Set R = New ADODB.Recordset
    sCadRep = "."
    
    'Cabecera
    sCadRep = sCadRep & Space(1) & "CMAC MAYNAS S.A." & Space(50) & "FECHA : " & Format(Now(), "dd/mm/yyyy hh:mm:ss") & Chr(10)
    sCadRep = sCadRep & Space(5) & "SIMACC-Tarjeta de Debito" & Space(42) & "Usuario : " & gsCodUser & Chr(10) & Chr(10)
    sCadRep = sCadRep & Space(40) & "REPORTE DE DETALLE DE TARJETAS ACTIVADAS" & Chr(10) & Chr(10) & Chr(10)
    sCadRep = sCadRep & Space(1) & String(105, "-") & Chr(10)
    sCadRep = sCadRep & Space(1) & "TARJETA" & Space(14) & "CUENTA" & Space(10) & "FECHA ACTIV." & Space(14) & "CLIENTE" & Space(12) & "USUARIO" & Space(7) & "AGENCIA" & Space(5) & Chr(10)
    sCadRep = sCadRep & Space(1) & String(105, "-") & Chr(10)
    ...
    Do While Not R.EOF
        sCadRep = sCadRep & Space(1) & Left(R!cNumTarjeta & Space(16), 16) & Space(1) & Left(R!cCtaCod & Space(18), 18) & Space(1) & Format(R!dFecActivacion, "dd/mm/yyyy hh:mm:ss") & Space(1) & Left(R!cPersNombre & Space(30), 25) & Space(1) & Left(R!cUserActiv & Space(20), 13) & Space(1) & Left(R!cAgeDescripcion & Space(20), 20) & Chr(10)
        Cont = Cont + 1
        R.MoveNext
    Loop
    R.Close
    ...
    sCadRep = sCadRep & Space(1) & String(105, "-") & Chr(10)
    sCadRep = sCadRep & Space(1) & "CANTIDAD :  " & Str(Cont) & Chr(10)
    sCadRep = sCadRep & Space(1) & String(105, "-") & Chr(10)
