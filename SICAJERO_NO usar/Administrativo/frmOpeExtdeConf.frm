...
Begin VB.Form frmOpeExtdeConf 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Extorno de Confirmación"
   ClientHeight    =   6810
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6555
   Icon            =   "frmOpeExtdeConf.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6810
   ...
   End
End
Attribute VB_Name = "frmOpeExtdeConf"
...
Private Sub cmdExtornar_Click()
    ...
    Call grabarDatos(4, lvwOperaciones.SelectedItem.Text)
...
Dim cant As Long
    ...
    Call CargaDatosListView(4, CInt(Mid(cboOrigen.Text, 1, InStr(cboOrigen.Text, "-") - 1)), CInt(Mid(cboDestino.Text, 1, InStr(cboDestino.Text, "-") - 1)))
