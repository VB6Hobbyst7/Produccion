VERSION 5.00
Begin VB.Form frmStockCuadreTarjeta 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Cuadre Tarjetas"
   ClientHeight    =   4425
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6030
   Icon            =   "frmStockCuadreTarjeta.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4425
   ...
   End
End
Attribute VB_Name = "frmStockCuadreTarjeta"
...
Dim sCadRep As String
    ...
    sCadRep = sCadRep & Space(30) & "Reporte Del Cuadre de Tarjetas DE: " & gsCodUser & "-" & gsNomUser & Chr(10) & Chr(10) & Chr(10)
...
Private Sub CargaValores()
    ...
    Dim R As ADODB.Recordset
        ...
        Cmd.CommandText = "ATM_RegistraCuadreTarjeta"
        Dim i As Integer
...
'        Next
        ...
        lblStockAct = Cmd.Parameters(5).Value
        lblSaldoF = Cmd.Parameters(6).Value
        lblDiferencia = Cmd.Parameters(7).Value
        LblMovim = Cmd.Parameters(8).Value
