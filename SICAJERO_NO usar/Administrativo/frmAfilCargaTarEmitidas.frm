...
Begin VB.Form frmAfilCargaTarEmitidas 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Registro de Archivo de Tarjetas Emitidas"
   ClientHeight    =   4170
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9405
   Icon            =   "frmAfilCargaTarEmitidas.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4170
   ...
   End
End
Attribute VB_Name = "frmAfilCargaTarEmitidas"
...
Dim dFecVenc As Date
    ...
    For i = 1 To Me.LstTarjetas.ListItems.Count
        ...
        Set Prm = New ADODB.Parameter
        Set Prm = Cmd.CreateParameter("@cUserAfil", adVarChar, adParamInput, 20, gsCodUser)
        Cmd.Parameters.Append Prm

        oConec.AbreConexion
        Cmd.ActiveConnection = oConec.ConexionActiva 'AbrirConexion
        Cmd.CommandType = adCmdStoredProc
        Cmd.CommandText = "ATM_RegistraTarjetaEmitida"
        Cmd.Execute
