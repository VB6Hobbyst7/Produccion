VERSION 5.00
Begin VB.Form frmRepTarjetasBloq 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Reporte de Tarjetas Bloqueadas"
   ClientHeight    =   2415
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5130
   Icon            =   "frmRepTarjetasBloq.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRepTarjetasBloq"
...
sSQL = " REP_TarjetaBloq '" & Format(CDate(Me.txtfecIni.Text), "mm/dd/yyyy") & "','" & Format(CDate(Me.txtFecFin.Text), "mm/dd/yyyy") & "','" & Trim(Str(Me.ChkUsu.Value)) & "','" & Trim(Me.TxtUsu.Text) & "','" & Trim(Str(Me.ChkAge.Value)) & "','" & Trim(Me.CboAgencia.Text) & "'"
...
sCadRep = sCadRep & Space(40) & "REPORTE DE TARJETAS BLOQUEADAS" & Chr(10) & Chr(10) & Chr(10)
sCadRep = sCadRep & Space(5) & String(120, "-") & Chr(10)
sCadRep = sCadRep & Space(5) & "TARJETA" & Space(20) & "FECHA BLOQUEO" & Space(10) & "CLIENTE" & Space(18) & "USUARIO" & Space(10) & "AGENCIA" & Space(10) & "MOTIVO" & Chr(10)
sCadRep = sCadRep & Space(5) & String(120, "-") & Chr(10)
Cont = 0
'AbrirConexion
oConec.AbreConexion
...
Do While Not R.EOF
    sCadRep = sCadRep & Space(5) & Right(Space(16) & R!cNumTarjeta, 16) & Space(5) & Format(R!dFecBloqCancelTarj, "dd/mm/yyyy hh:mm:ss") & Space(5) & Left(R!cPersNombre & Space(30), 30) & Space(2) & Left(R!cUserBloqCanc & Space(10), 10) & Space(2) & Left(R!cAgeDescripcion & Space(20), 18) & Space(2) & Left(R!cMotivo & Space(20), 15) & Chr(10)
    Cont = Cont + 1
    R.MoveNext
Loop
R.Close
