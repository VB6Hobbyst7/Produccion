...
Sub RegistrarOperacionInterCMAC(psNumTarj As String, ByVal psClave As String, ByVal psCtaCod As String, ByVal psOpeCod As String, psTrack2 As String, pnMoneda As Moneda, _
    ...
    Call GeneraTrama(psNumTarj, psCtaCod, "", pnMonto, psTrack2, lsCodAutCMAC, pnMoneda, psDni, psNombreCMAC, "810900", psClave)
