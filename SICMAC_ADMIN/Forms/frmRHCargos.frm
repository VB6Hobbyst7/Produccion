...
Begin VB.Form frmRHCargos 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmRHCargos.frx":030A
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame1"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "&Cargos"
      TabPicture(1)   =   "frmRHCargos.frx":0326
      ...
      Begin VB.Frame Frame3 
         ...
         Begin TabDlg.SSTab SSTab 
            ...
            ForeColor       =   8388608
            TabCaption(0)   =   "Datos"
            TabPicture(0)   =   "frmRHCargos.frx":0342
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "fraDatos"
            Tab(0).Control(0).Enabled=   0   'False
            Tab(0).ControlCount=   1
            TabCaption(1)   =   "Areas"
            TabPicture(1)   =   "frmRHCargos.frx":035E
            Tab(1).ControlEnabled=   0   'False
            Tab(1).Control(0)=   "fraAreas"
            Tab(1).ControlCount=   1
            TabCaption(2)   =   "Def Planeamiento"
            TabPicture(2)   =   "frmRHCargos.frx":037A
