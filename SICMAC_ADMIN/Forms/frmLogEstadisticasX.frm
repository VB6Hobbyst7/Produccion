...
Begin VB.Form frmLogEstadisticas 
   ...
   Begin TabDlg.SSTab sstReg 
      ...
      TabPicture(0)   =   "frmLogEstadisticasX.frx":0000
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "flxVis"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "cmdSalir"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "fraRep01"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "fraRep02"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).ControlCount=   4
      TabCaption(1)   =   "Gráfico            "
      TabPicture(1)   =   "frmLogEstadisticasX.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Label7"
      Tab(1).Control(1)=   "spEscala"
      Tab(1).Control(2)=   "chkGrafico"
      Tab(1).Control(3)=   "GRAF"
      Tab(1).ControlCount=   4
      Begin MSChart20Lib.MSChart GRAF 
         Height          =   4455
         Left            =   -74640
         OleObjectBlob   =   "frmLogEstadisticasX.frx":0038
         TabIndex        =   24
         Top             =   840
         Width           =   7455
      End
      Begin VB.Frame fraRep02 
         ...
         Begin VB.ComboBox cboMes 
            Height          =   315
            ItemData        =   "frmLogEstadisticasX.frx":238E
            Left            =   1200
            List            =   "frmLogEstadisticasX.frx":23B9
            Style           =   2  'Dropdown List
            TabIndex        =   18
            Top             =   240
            Width           =   1635
      ...
      Begin VB.Frame fraRep01 
         ...
         Begin VB.ComboBox cboMoneda 
            Height          =   315
            ItemData        =   "frmLogEstadisticasX.frx":2422
            Left            =   1800
            List            =   "frmLogEstadisticasX.frx":242C
            Style           =   2  'Dropdown List
            TabIndex        =   11
            Top             =   240
            Width           =   1335
