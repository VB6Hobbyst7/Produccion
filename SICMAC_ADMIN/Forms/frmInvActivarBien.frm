...
Begin VB.Form frmInvActivarBien 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Activar Bien como Activo Fijo Soles"
   ClientHeight    =   6870
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13470
   ...
   EndProperty
   Icon            =   "frmInvActivarBien.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmInvActivarBien"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'********************************************************************
'** Nombre : frmInvActivarBien
'** Descripción : Formulario para Listar los BS filtrados por Activo Fijo en Soles
...
Private Sub CargarDatos()
    ...
    Set rsCargar = oInventario.DarOrdenCompraXAF(Format(mskIni.Text, "yyyymmdd"), Format(mskFin.Text, "yyyymmdd"), "251601")
