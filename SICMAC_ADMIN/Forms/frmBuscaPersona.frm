...
Private Sub cmdAceptar_Click()
   ...
   Else
        ...
        End If
   End If
   Call Persona.CargaDatos(R!cPersCod, R!cPersNombre, Format(IIf(IsNull(R!dPersNacCreac), "09/09/9999", R!dPersNacCreac), gsFormatoFechaView), IIf(IsNull(R!cPersDireccDomicilio), "", R!cPersDireccDomicilio), IIf(IsNull(R!cPersTelefono), "", IIf(IsNull(R!cPersTelefono), "", R!cPersTelefono)), R!nPersPersoneria, IIf(IsNull(R!cPersIDnroDNI), "", R!cPersIDnroDNI), IIf(IsNull(R!cPersIDnroRUC), "", R!cPersIDnroRUC), IIf(IsNull(R!cPersIDnro), "", R!cPersIDnro), IIf(IsNull(R!cPersNatSexo), "", R!cPersNatSexo))
   Set R = Nothing
