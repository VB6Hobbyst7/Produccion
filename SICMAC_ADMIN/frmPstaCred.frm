...
Begin VB.Form frmPstaCred 
   ...
   Begin VB.Frame fradatosgenerales 
      ...
      Top             =   -30
      Width           =   10755
      Begin Contabilidad.ActxCtaCred lblCodCred 
         Height          =   495
         Left            =   120
         TabIndex        =   159
         Top             =   240
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(5)   =   "frmPstaCred.frx":0478
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "fragarantias"
      Tab(5).ControlCount=   1
      TabCaption(6)   =   "&Otros Datos"
      TabPicture(6)   =   "frmPstaCred.frx":0494
...
Private Sub EncabCalMora(CodCta As String)
    rtf.Text = rtf.Text & Space(5) & gsNomCmac & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & gsNomAge & Space(100) & "Fecha : " & Format(gdFecSis + Time, "dd/mm/yyyy hh:mm:ss AMPM") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & CentrarCadena("CALCULO DE MORA DEL CREDITO " & CodCta, 150) & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & Chr(10)
...
If Me.listaClientes.ListItems.Count > 0 Then
    ...
    lnNumLineas = 0
    ImprimirPstaCred
    frmPrevio.Previo rtf, "REPORTE GENERAL DE CREDITO", True, 66
Else
...
rtf.Text = rtf.Text & Space(5) + Chr(27) + Chr(69) + "CLIENTES RELACIONADOS" + Space(95 - Len("DATOS GENERALES DEL CREDITO")) & "DATOS GENERALES DEL CREDITO" + Chr(27) + Chr(70) + Chr(10)
lnNumLineas = lnNumLineas + 1
rtf.Text = rtf.Text & Space(5) & String(Ancho, "-") & Space(9) & String(Ancho, "-") & Chr(10)
lnNumLineas = lnNumLineas + 1
rtf.Text = rtf.Text & Space(5) & "NOMBRE" & Space(43) & "RELACIONES" & Space(15) & "Linea de Credito     : " & Me.lblLinea + Chr(10)
lnNumLineas = lnNumLineas + 1
rtf.Text = rtf.Text & Space(5) & String(Ancho, "-") & Space(9) & "Fuente de Ingreso    : " & lblfuente & Chr(10)
lnNumLineas = lnNumLineas + 1
For i = 1 To listaClientes.ListItems.Count
    If i = 1 Then
        ...
        rtf.Text = rtf.Text & Space(14) & "Analista Responsable : " & lblanalista & Chr(10)
        lnNumLineas = lnNumLineas + 1
    End If
    If i = 2 Then
        rtf.Text = rtf.Text & Space(5) & CadDerecha(PstaNombre(listaClientes.ListItems(i), False), 50) & CadDerecha(listaClientes.ListItems(i).SubItems(1), 10)
        rtf.Text = rtf.Text & Space(14) & "Apoderado            : " & lblapoderado & Chr(10)
        lnNumLineas = lnNumLineas + 1
    End If
    If i = 3 Then
        rtf.Text = rtf.Text & Space(5) & CadDerecha(PstaNombre(listaClientes.ListItems(i), False), 50) & CadDerecha(listaClientes.ListItems(i).SubItems(1), 10)
        rtf.Text = rtf.Text & Space(14) & "Condición de Crédito : " & CadDerecha(lblcondicion, 15) & Space(7) & "Nota 1  : " & lblnota1 & Chr(10)
        lnNumLineas = lnNumLineas + 1
    End If
    If i = 4 Then
        rtf.Text = rtf.Text & Space(5) & CadDerecha(PstaNombre(listaClientes.ListItems(i), False), 50) & CadDerecha(listaClientes.ListItems(i).SubItems(1), 10)
        rtf.Text = rtf.Text & Space(14) & "Destino del Crédito  : " & CadDerecha(lbldestino, 20) & Space(3) & "Nota 2 : " & lblnota2 & Chr(10)
        lnNumLineas = lnNumLineas + 1
    End If
    If i = 5 Then
        rtf.Text = rtf.Text & Space(5) & CadDerecha(PstaNombre(listaClientes.ListItems(i), False), 50) & CadDerecha(listaClientes.ListItems(i).SubItems(1), 10)
        rtf.Text = rtf.Text & Space(14) & "Tipo de Cuota        : " & CadDerecha(Me.lbltipocuota, 20) & Chr(10)
        lnNumLineas = lnNumLineas + 1
    End If

Next
If i > 5 Then
    rtf.Text = rtf.Text & Space(5) & String(150, "-") & Chr(10)
End If
Select Case i
    Case 1
        rtf.Text = rtf.Text & Space(79) & "Analista Responsable : " & lblanalista & Chr(10)
        lnNumLineas = lnNumLineas + 1
        rtf.Text = rtf.Text & Space(79) & "Apoderado            : " & lblapoderado & Chr(10)
        lnNumLineas = lnNumLineas + 1
        rtf.Text = rtf.Text & Space(79) & "Condición de Crédito : " & CadDerecha(lblcondicion, 15) & Space(8) & "Nota 1 : " & lblnota1 & Chr(10)
        lnNumLineas = lnNumLineas + 1
        rtf.Text = rtf.Text & Space(79) & "Destino del Crédito  : " & CadDerecha(lbldestino, 20) & Space(3) & "Nota 2 : " & lblnota2 & Chr(10)
        lnNumLineas = lnNumLineas + 1
        rtf.Text = rtf.Text & Space(79) & "Tipo de Cuota        : " & CadDerecha(Me.lbltipocuota, 20) & Chr(10)
        lnNumLineas = lnNumLineas + 1
    Case 2
        rtf.Text = rtf.Text & Space(79) & "Apoderado            : " & lblapoderado & Chr(10)
        lnNumLineas = lnNumLineas + 1
...
If Val(lblmontosolicitud) > 0 Then
    'rtf.Text = rtf.Text & Chr(10)
    'lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) + Chr(27) + Chr(69) + "HISTORIAL DEL CREDITO" + Chr(27) + Chr(70) + Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & String(140, "-") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & Space(13) & " FECHA " & Space(10) & " MONTO " & Space(10) & "Nº CUOTAS" & Space(16) & "PLAZO" & Space(10) & "CUOTA" & Space(10) & "P.GRACIA" & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & String(140, "-") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & "SOLICITADO : " & lblfechsolicitud & Space(15 - Len(Format(lblmontosolicitud, "#,#0.00"))) & Format(lblmontosolicitud, "#,#0.00") & Space(15 - Len(Format(lblcuotasSolicitud, "#0"))) & Format(lblcuotasSolicitud, "#0") & Space(25 - Len(Format(lblPlazoSolicitud, "#0") & " Días")) & Format(lblPlazoSolicitud, "#0") & " Días" & Chr(10)
    If Val(lblMontosugerido) > 0 Then
        rtf.Text = rtf.Text & Space(5) & "SUGERIDO   : " & Space(25 - Len(Format(lblMontosugerido, "#,#0.00"))) & Format(lblMontosugerido, "#,#0.00") & Space(15 - Len(Format(lblcuotasugerida, "#0"))) & Format(lblcuotasugerida, "#0") & Space(25 - Len(Format(lblPlazoSugerido, "#0") & " Días")) & Format(lblPlazoSugerido, "#0") & " Días" & Space(15 - Len(Format(lblmontoCuotaSugerida, "#,#0.00"))) & Format(lblmontoCuotaSugerida, "#,#0.00") & Space(10 - Len(Format(lblGraciasugerida, "#0"))) & Format(lblGraciasugerida, "#0") & Chr(10)
    End If
    If Val(lblMontoAprobado) > 0 Then
        rtf.Text = rtf.Text & Space(5) & "APROBADO   : " & lblfechaAprobado & Space(15 - Len(Format(lblMontoAprobado, "#,#0.00"))) & Format(lblMontoAprobado, "#,#0.00") & Space(15 - Len(Format(lblcuotasAprobado, "#0"))) & Format(lblcuotasAprobado, "#0") & Space(25 - Len(Format(lblPlazoAprobado, "#0") & " Días")) & Format(lblPlazoAprobado, "#0") & " Días" & Space(15 - Len(Format(lblmontoCuotaAprobada, "#,#0.00"))) & Format(lblmontoCuotaAprobada, "#,#0.00") & Space(10 - Len(Format(lblGraciaAprobada, "#0"))) & Format(lblGraciaAprobada, "#0") & Chr(10)
    End If
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Chr(10)
    lnNumLineas = lnNumLineas + 1
...
If listaDesembolsos.ListItems.Count > 0 Then
    rtf.Text = rtf.Text & Space(5) & Chr(27) & Chr(69) & "DESEMBOLSOS REALIZADOS" & Chr(27) & Chr(70) & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & String(140, "-") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & "  FECHA      " & Space(17) & "MONTO" & Space(10) & "GASTOS" & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & String(140, "-") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    For i = 1 To listaDesembolsos.ListItems.Count
        rtf.Text = rtf.Text & Space(5) & listaDesembolsos.ListItems(i) & Space(25 - Len(listaDesembolsos.ListItems(i).SubItems(2))) & Format(listaDesembolsos.ListItems(i).SubItems(2), "#,#0.00") & Space(15 - Len(listaDesembolsos.ListItems(i).SubItems(3))) & Format(listaDesembolsos.ListItems(i).SubItems(3), "#,#0.00") & Chr(10)
        lnNumLineas = lnNumLineas + 1
       ' If lnNumLineas > 50 Then
       '     rtf.Text = rtf.Text & Chr(12)
       '     lnNumLineas = 0
       '     Encabezado
       '     rtf.Text = rtf.Text & Space(5) + Chr(27) + Chr(69) + "DESEMBOLSOS REALIZADOS" + Chr(27) + Chr(70) + Chr(10)
       '     lnNumLineas = lnNumLineas + 1
...
If ListaPagos.ListItems.Count > 0 Then
    rtf.Text = rtf.Text & Space(5) & Chr(27) & Chr(69) & "PAGOS REALIZADOS" & Chr(27) & Chr(70) & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & String(140, "-") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & "  FECHA" & Space(8) & "CUOTA" & Space(5) & "MONTO PAG" & Space(8) & "CAPITAL" & Space(7) & "INTERES" & Space(10) & "MORA" & Space(10) & "GASTOS" & Space(5) & "DIAS ATR." & Space(2) & "Saldo Cap." & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & String(140, "-") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    ...
    rtf.Text = rtf.Text & Space(5) & "TOTAL PAGADO :" & Space(33 - Len(Format(lblcapitalpagado, "#,#0.00"))) & Format(lblcapitalpagado, "#,#0.00") & Space(15 - Len(Format(lblintcompPag, "#,#0.00"))) & Format(lblintcompPag, "#,#0.00") & Space(15 - Len(Format(lblIntMorPag, "#,#0.00"))) & Format(lblIntMorPag, "#,#0.00") & Space(15 - Len(Format(lblGastopagado, "#,#0.00"))) & Format(lblGastopagado, "#,#0.00") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    If lnNumLineas > 50 Then
        rtf.Text = rtf.Text & Chr(12)
        lnNumLineas = 0
...
If lstCuotasPend.ListItems.Count > 0 Then
    rtf.Text = rtf.Text & Space(5) + Chr(27) + Chr(69) + "CUOTAS PENDIENTES" + Chr(27) + Chr(70) + Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & String(140, "-") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & "  CUOTA" & Space(3) & "FECHA VENC." & Space(8) & "CAPITAL" & Space(9) & "INTERES" & Space(9) & "MORA" & Space(5) & "DIAS ATR." & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & String(140, "-") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    For i = 1 To lstCuotasPend.ListItems.Count
        rtf.Text = rtf.Text & Space(10 - Len(Format(lstCuotasPend.ListItems(i), "#0"))) & Format(lstCuotasPend.ListItems(i), "#0") & Space(5) & lstCuotasPend.ListItems(i).SubItems(1) & Space(15 - Len(Format(lstCuotasPend.ListItems(i).SubItems(2), "#,#0.00"))) & Format(lstCuotasPend.ListItems(i).SubItems(2), "#,#0.00") & Space(15 - Len(Format(lstCuotasPend.ListItems(i).SubItems(3), "#,#0.00"))) & Format(lstCuotasPend.ListItems(i).SubItems(3), "#,#0.00") _
                    & Space(15 - Len(Format(lstCuotasPend.ListItems(i).SubItems(4), "#,#0.00"))) & Format(lstCuotasPend.ListItems(i).SubItems(4), "#,#0.00") & Space(10 - Len(Format(lstCuotasPend.ListItems(i).SubItems(5), "#0"))) & Format(lstCuotasPend.ListItems(i).SubItems(5), "#0") & Chr(10)
        lnNumLineas = lnNumLineas + 1
        If lnNumLineas > 54 Then
            rtf.Text = rtf.Text & Chr(12)
            lnNumLineas = 0
    ...
    If lnNumLineas >= 44 And lnNumLineas <= 52 Then
        ...
        Encabezado
    End If
    rtf.Text = rtf.Text & Space(5) + Chr(27) + Chr(69) & "CUOTAS ATRASADAS" + Space(65) + "PAGO AL " & Format(gdFecSis, "dd/mm/yyyy") + Chr(27) + Chr(70) + Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & String(70, "-") + Space(10) & String(60, "-") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & "CAPITAL         :" & ImpreFormat(CDbl(Me.lblCapitalCuoPend), 15, 2, True)
    rtf.Text = rtf.Text & Space(45) & "CAPITAL         : " & ImpreFormat(CDbl(Me.lblSaldoKFecha), 15, 2, True) & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & "INTERES         :" & ImpreFormat(CDbl(Me.lblInteresCuoPend), 15, 2, True)
    rtf.Text = rtf.Text & Space(45) & "INTERES         :" & ImpreFormat(CDbl(Me.lblIntCompFecha), 15, 2, True) & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & "MORA            :" & ImpreFormat(CDbl(Me.lblMoraCuoPend), 15, 2, True)
    rtf.Text = rtf.Text & Space(45) & "MORA            :" & ImpreFormat(CDbl(Me.lblIntMorFecha), 15, 2, True) & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & "GASTOS          :" & ImpreFormat(CDbl(Me.lblGastoCuoPend), 15, 2, True)
    rtf.Text = rtf.Text & Space(45) & "GASTOS          :" & ImpreFormat(CDbl(Me.lblGastoFecha), 15, 2, True) & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(85) & "INT SUSPENSO    :" & ImpreFormat(CDbl(Me.lblIntSuspFecha), 15, 2, True) & Chr(10)
    lnNumLineas = lnNumLineas + 1
    
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) & String(70, "-") + Space(10) & String(60, "-") & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Space(5) + Chr(27) + Chr(69) + "TOTAL           :" & ImpreFormat(CDbl(Me.lblTotalCuoPend), 15, 2, True)
    rtf.Text = rtf.Text & Space(45) & "TOTAL           :" & ImpreFormat(CDbl(Me.lblTotalFecha), 15, 2, True) & Chr(27) & Chr(70) & Chr(10)
    lnNumLineas = lnNumLineas + 1
    rtf.Text = rtf.Text & Chr(10)
    lnNumLineas = lnNumLineas + 1
    If lnNumLineas > 50 Then
...
End If
rtf.Text = rtf.Text & Space(5) + Chr(27) + Chr(69) + "OTROS DATOS" + Chr(27) + Chr(70) + Chr(10)
lnNumLineas = lnNumLineas + 1
rtf.Text = rtf.Text & Space(10) & "PROTESTO          : " & IIf(chkProtesto.Value = 1, "Si", "No") & Chr(10)
rtf.Text = rtf.Text & Space(10) & "CARGO AUTOMATICO  : " & IIf(chkCargoAuto.Value = 1, "Si", "No") & Chr(10)
rtf.Text = rtf.Text & Space(10) & "REFINANCIADO      : " & IIf(chkRefinanciado.Value = 1, "Si", "No") & Chr(10)

End Sub
Private Sub Encabezado()

rtf.Text = rtf.Text & "@" & Space(4) & gsNomCmac & Space(85) & "Fecha : " & Format(gdFecSis + Time, "dd/mm/yyyy hh:mm") & Chr(10)
lnNumLineas = lnNumLineas + 1
rtf.Text = rtf.Text & Space(5) & gsNomAge & Space(96) & "Usuario: " & gsCodUser & "  " & Chr(10)
lnNumLineas = lnNumLineas + 1
lnNumLineas = lnNumLineas + 1
rtf.Text = rtf.Text & Space(5) & CentrarCadena("R E S U M E N   G E N E R A L   D E   C R E D I T O", 150) & Chr(10)
lnNumLineas = lnNumLineas + 1
rtf.Text = rtf.Text & Space(5) & Chr(10)
lnNumLineas = lnNumLineas + 1
rtf.Text = rtf.Text & Space(5) & Chr(27) + Chr(69) & "Crédito Nº :" & Trim(lblCodCred.Text) + Chr(27) + Chr(70) & Space(10) & "Tipo : " & CadDerecha(lbltipoCredito, 50) & Space(2) & "Estado :" & lblEstado & Chr(10)
lnNumLineas = lnNumLineas + 1
rtf.Text = rtf.Text & Space(5) & Chr(10)
End Sub
...
Private Sub DatosGenerales(psCodCta As String, dbConexion As ADODB.Connection)
Dim sql As String
...
rs.Open sql, dbConexion, adOpenKeyset, adLockReadOnly, adCmdText
If RSVacio(rs) Then
...
If AbreConeccion(Trim(Agencia)) Then
...
ErrorConexionPsta:
    ...
    Screen.MousePointer = 0
End Sub
Private Sub CargaClientes(psCodCred As String, dbConexion As ADODB.Connection)
...
rsC.Open sql, dbConexion, adOpenForwardOnly, adLockOptimistic, adCmdText
If RSVacio(rsC) Then
...
Set rsC = Nothing
End Sub
Private Sub CargaDesembolsos(psCodCred As String, dbConexion As ADODB.Connection)
Dim sql As String
...
rsD.Open sql, dbConexion, adOpenForwardOnly, adLockOptimistic, adCmdText
...
Else
    ...
    Do While Not rsD.EOF
        ...
        ItemD.SubItems(3) = MontoGastos(Trim(rsD!cNroCuo), Trim(rsD!cTipo), Trim(psCodCred), dbConexion)
        rsD.MoveNext
    Loop
End If
rsD.Close
...
End Sub
Private Sub CargaPagos(psCodCred As String, lnMontoDesemb As Currency, dbConexion As ADODB.Connection)
Dim sql As String
Dim rsD As New ADODB.Recordset
Dim GastoCuota As String
Dim TotalPagado As String
...
sql = "SELECT Kardex.cCodCta, " _
    ...
    & "(SUBSTRING(Kardex.cCodOpe,1,4) NOT IN ('" & Left(gsDesCCN, 4) & "' ) AND KARDEX.CCODOPE NOT  IN ('019998')) " _
...
Private Function DatoProximo(psCodCta As String, lsCuota As String, dbConexion As ADODB.Connection, Optional psDato As String = "1", Optional psTipo As String = "D") As String
Dim sql As String
...
If dbConexion = dbCmact Then
    Set rsP = CargaRecord(sql)
    If RSVacio(rsP) Then
        lsCadena = ""
    Else
...
End Function
Private Function TotalDesembolso(psCodCta As String, dbConexion As ADODB.Connection) As String
Dim sql As String
Dim rsP As New ADODB.Recordset
...
rsP.Open sql, dbConexion, adOpenForwardOnly, adLockOptimistic, adCmdText
If RSVacio(rsP) Then
    TotalDesembolso = ""
Else
...
Private Sub DatosPlanDesPag(psCodCta As String, dbConexion As ADODB.Connection)
Dim sql As String
Dim rs As New ADODB.Recordset
...
rs.Open sql, dbConexion, adOpenForwardOnly, adLockReadOnly, adCmdText
...
If Not RSVacio(rs) Then
    ...
    Else
       Me.lblIntGraciaApr = TotalIntGracia(psCodCta, dbConexion)
    End If
    ...
    Do While Not rs.EOF
        ...
        If rs!DiasMora > 0 Then  ' Cuotas Pendiente
           ...
           rsGas.Open sql, dbConexion, adOpenForwardOnly, adLockReadOnly, adCmdText
...
nSaldos = 0
End Sub
Sub CargaGastos(CodCta As String, Conexion As ADODB.Connection)
...
Dim SQL1 As String
    SQL1 = "SELECT cCodGas,cEstado,nNroCuo,(nMonNeg - nMonPag) AS Gasto FROM PlanGastos " & _
           ...
           " Order By nNroCuo"
    ContGastos = 0
    RegGastos.Open SQL1, Conexion, adOpenStatic, adLockReadOnly, adCmdText
...
Dim Acum As Double
    ...
    GastoCuota = Acum
End Function
Sub SaldoCapitalesCuota(ByVal CodCta As String, Conexion As ADODB.Connection)
...
Dim Monto As Double
    ...
    RCred.Open SQL1, Conexion, adOpenStatic, adLockReadOnly, adCmdText
...
Sub CargaCuotas(ByVal CodCta As String, Conexion As ADODB.Connection)
...
Dim SQL1 As String
    ...
    'Realiza Carga de Datos
        ...
        RegCuotas.Open SQL1, Conexion, adOpenStatic, adLockReadOnly, adCmdText
...
End Sub
Function TotalDeudaParcial(Conexion As ADODB.Connection) As Double
Dim SQL1 As String
...
Dim i, NumDias As Integer
    ...
    TotalDeuda = Monto
End Function
Private Sub Garantias(lsCodCred As String, dbConexion As ADODB.Connection)
...
rsg.Open sql, dbConexion, adOpenForwardOnly, adLockOptimistic, adCmdText
...
Private Function TotalIntGracia(pCodCta As String, pConex As ADODB.Connection) As Double
Dim sql As String
Dim rs As New ADODB.Recordset
...
Dim sql As String
Dim rs As New ADODB.Recordset
sql = " SELECT nValFijo FROM " & gcCentralCom & "TipCambio WHERE DATEPART(mm,dFecCamb) =  datepart(mm,'" & Format(gdFecSis, "mm/dd/yyyy") & "')"
rs.Open sql, dbCmact, adOpenStatic, adLockReadOnly, adCmdText
If RSVacio(rs) Then
  MsgBox "El Tipo de Cambio Fijo no Ha sido Ingresado ", vbInformation, "Aviso"
Else
  ObtieneTipoCambioFijo = rs!nValFijo
End If
  rs.Close
  Set rs = Nothing
End Function
...
Private Sub CargaRefinanciados(psCodCred As String, dbConexion As ADODB.Connection)
Dim sql As String
...
rsR.Open sql, dbConexion, adOpenForwardOnly, adLockOptimistic, adCmdText
