...
Begin VB.UserControl VerticalMenu 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   176
   ToolboxBitmap   =   "VertMenu.ctx":0479
...
'Event Declarations:
Event ValidaMenuItem(pnItem As Long, Cancel As Boolean)
Event Show()
Event Resize()
Event Hide()
Event Click()
    ...
    If Button = vbLeftButton Then
        With mMenus
            ...
            If lHitType = HIT_TYPE_MENU_BUTTON And lIndex > 0 Then
                RaiseEvent ValidaMenuItem(lIndex, lbCancel)
                If lbCancel Then
                    MenuCur = lIndex
                End If
            End If
...
Attribute MenusMax.VB_ProcData.VB_Invoke_Property = "General"
    On Error Resume Next
    MenusMax = mlMenusMax
End Property
...
Attribute MenuCur.VB_ProcData.VB_Invoke_Property = "Menues"
    MenuCur = mlMenuCur
End Property
...
Attribute MenuStartup.VB_ProcData.VB_Invoke_Property = "Menues"
    On Error Resume Next
...
Attribute MenuCaption.VB_ProcData.VB_Invoke_Property = "MenuObjects"
    On Error Resume Next
...
Attribute MenuItemCaption.VB_ProcData.VB_Invoke_Property = "MenuItemObjects"
    On Error Resume Next
...
Attribute MenuItemKey.VB_ProcData.VB_Invoke_Property = "MenuItemObjects"
    On Error Resume Next
...
Attribute MenuItemTag.VB_ProcData.VB_Invoke_Property = "MenuItemObjects"
    On Error Resume Next
...
Attribute MenuItemsMax.VB_ProcData.VB_Invoke_Property = "MenuObjects"
    On Error Resume Next
...
Attribute MenuItemCur.VB_ProcData.VB_Invoke_Property = "MenuObjects"
    On Error Resume Next
