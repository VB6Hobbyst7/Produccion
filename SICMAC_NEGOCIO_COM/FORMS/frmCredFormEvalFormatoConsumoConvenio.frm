...
Begin VB.Form frmCredFormEvalFormatoConsumoConvenio 
   ...
   Caption         =   "Créditos - Evaluación - Formato Descuento Por Planilla."
   ClientHeight    =   9990
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   12420
...
Public Function Inicio(ByVal psTipoRegMant As Integer, ByVal psCtaCod As String, ByVal pnFormato As Integer, ByVal pnProducto As Integer, _
    ...
    Set rsAceptableCritico = oDCOMFormatosEval.RecuperaDatosRatiosAceptableCritico(psCtaCod) 'Obtenemos Datos, Aceptable / Critico de los Ratios'CTI320200110 ERS003-2020. Agregó
    ...
    fnFormato = pnFormato 'CTI320200110 ERS003-2020. Agregó
    Call CargarFlexEdit 'CTI320200110 ERS003-2020. Agregó
...
Private Sub cmdActualizarConConvenio_Click()
    Dim oNCOMFormatosEval As COMNCredito.NCOMFormatosEval
    Dim oDCOMFormatosEval As COMDCredito.DCOMFormatosEval    'CTI320200110 ERS003-2020. Agregó
...
If Validar Then
    ...
    Set objPista = New COMManejador.Pista
        ...
        Set rsGastoFam = IIf(feGastosFamiliares.rows - 1 > 0, feGastosFamiliares.GetRsNew(), Nothing) 'CTI320200110 ERS003-2020. Agregó
        ...
        ActualizarDatos = oNCOMFormatosEval.ActualizarConsumoConConvenio_InfCliente(fsCtaCod, 8, txtInfNegocioActividad.Text, spnInfNegocioAño.valor, spnInfNegocioMes.valor, _
                                                        ...
                                                        'rsGastoFam, MatIfiGastoFami, MatIfiNoSupervisadaGastoFami 'CTI320200110 ERS003-2020. Agregó
        
                                              
        If ActualizarDatos Then
            'CTI320200110 ERS003-2020. Agregó
             Set oDCOMFormatosEval = New COMDCredito.DCOMFormatosEval 'CTI320200110 ERS003-2020. Agregó
...
Private Sub cmdGuardarConConvenio_Click()
    ...
    Set rsGastoFam = IIf(feGastosFamiliares.rows - 1 > 0, feGastosFamiliares.GetRsNew(), Nothing) 'CTI320200110 ERS003-2020. Agregó
        ...
        Set oNCOMFormatosEval = New COMNCredito.NCOMFormatosEval
                                                                                ...
                                                                                'IIf(txtFecUltEndeuda2.Text = "__/__/____", "01/01/1900", txtFecUltEndeuda2.Text)
        GrabarDatos = oNCOMFormatosEval.GuardarConsumoConConvenio_InfCliente(fsCtaCod, 8, txtInfNegocioActividad.Text, spnInfNegocioAño.valor, spnInfNegocioMes.valor, _
                                            txtInfNegocioUltDeuda.Text, IIf(txtFecUltEndeuda2.Text = "__/__/____", "01/01/1900", txtFecUltEndeuda2.Text), _
                                            fnTipoAportacion, fnTipoInstitucion, fnSectorSalud, fnTipoPlanilla, txtInstConv.Text, txtInfNegocioMontSolicitado.Text, _
                                            txtInfNegocioCuotas.Text, txtInfNegocioExpCredito.Text, CDate(txtInfNegocioFuenteIngreso.Text), _
...
End If
 ...
 '--------------------------------------------------------------------------------------------------------------------------
    ...
    'oDoc.WTextBox 770, 135, 1, 160, txtCapPagoConConvenio1.Text, "F1", 7.5, hRight CTI320200110 ERS003-2020. Comentó
    oDoc.WTextBox nFila + 110, 135, 1, 160, txtCapacidadNeta.Text, "F1", 7.5, hRight 'CTI320200110 ERS003-2020. Agregó
    ...
    oDoc.WTextBox nFila + 120, 55, 1, 160, "Cuota límite de descuento", "F1", 7.5, hjustify
    ...
    Call LimpiaFlex(fgIngresos)
        Do While Not rsFeDatOtrosIng.EOF
            If rsFeDatOtrosIng!nConsValor <> 1 Then
                ...
                Select Case CInt(fgIngresos.TextMatrix(fgIngresos.row, 1))
                    'Case 1, 5, 6 'CTI320200110 ERS003-2020. Comentó
                    Case 6 'CTI320200110 ERS003-2020. Agregó
                        fgIngresos.BackColorRow (&HC0FFFF)
                    'CTI320200110 ERS003-2020. Agregó
                    Case 4
                        If (CDbl(fgIngresos.TextMatrix(lnFila, 3)) <= 0) Then
