...
Begin VB.Form frmCapConsultaMovimientos 
   ...
   Begin VB.Frame fraMov 
      ...
      Begin TabDlg.SSTab SSMovs 
         ...
         Tab(2).Control(0)=   "grdMovDA"
         Tab(2).Control(1)=   "cmdAfilDebAuto"
         Tab(2).Control(2)=   "cmdImpDebAuto"
      ...
      Begin VB.Label lblRemuneraciones 
         Caption         =   "Total 6 Últimas Remu. Brutas"
         Height          =   255
         Left            =   120
         TabIndex        =   39
         Top             =   3900
...
Private Sub ObtieneDatosCuenta(ByVal sCuenta As String)
    ...
    If Not (rsCta.EOF And rsCta.BOF) Then
        ...
        lblTEA.Caption = Format(Round(ConvierteTNAaTEA(rsCta("nTasaInteres")), 2), "#.00") & " %" 'Add By GITU 17-04-2013
...
Else
    ...
    Else
        ...
        Do While Not rsCta.BOF
            ...
            grdMov.TextMatrix(grdMov.Rows - 1, 7) = rsCta("cAgencia")
        ...
        If rsCtaP.RecordCount > 0 Then
            ...
            Do While Not rsCtaP.BOF
                ...
                grdMovP.TextMatrix(grdMovP.Rows - 1, 7) = rsCtaP("cAgencia")
        ...
        If rsCtaDA.RecordCount > 0 Then
            ...
            Do While Not rsCtaDA.BOF
                ...
                grdMovDA.TextMatrix(grdMovDA.Rows - 1, 6) = rsCtaDA("cAgencia")
...
End If
        ...
        With rsO
            ...
            For i = 1 To grdMov.Rows - 1
                ...
                .Fields("sAgencia") = Left(Mid(grdMov.TextMatrix(i, 7), 9), 10)
            ...
            rsO.Sort = "dFecha,sOpeCod" 'JUEZ 20140128
...
If Not CargoAutomatico(sCuenta, nCntPag) Then Exit Sub
...
Private Function CargoAutomatico(psCuenta As String, pnCntPag As Integer, Optional ByVal pbImpDebitoAuto As Boolean = False) As Boolean
'JUEZ 20150224 Se agregó pbImpDebitoAuto
'ppoa
    Dim sMensajeCola As String
    Dim bExito As Boolean
    Dim nMonto As Double
    Dim bCobComDebitoAuto As Boolean
    bExito = False
            ...
            If nEstado <> gCapEstAnulada And nEstado <> gCapEstCancelada Then
                ...
                If nMonto > 0 Then
                    ...
                    If pbImpDebitoAuto Then
                        If Not oCap.ValidaComisionExtractoServCobDebitoAuto(psCuenta, gdFecSis) Then
                            nMonto = 0
                        ...
                        End If
                        nFlag = oCap.CapCargoCuentaAho(psCuenta, nMonto, gAhoDctoEmiExtDebitoAuto, sMovNro, "Descuento Emisión Extracto Debito Automático", , , , , , , , , gsNomAge, sLpt, , , , , gsCodCMAC, , gsCodAge, , False, nITF, , , , , sMensaje, sBoleta, sBoletaITF, , , gbImpTMU)
                    Else
                        nFlag = oCap.CapCargoCuentaAho(psCuenta, nMonto, gAhoDctoEmiExt, sMovNro, "Descuento Emisión Extracto", , , , , , , , , gsNomAge, sLpt, , , , , gsCodCMAC, , gsCodAge, , False, nITF, , , , , sMensaje, sBoleta, sBoletaITF, , , gbImpTMU)
                    End If
                    'END JUEZ *************************************************
