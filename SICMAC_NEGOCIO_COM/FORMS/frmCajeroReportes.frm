...
Option Explicit
Dim lsKey  As String
Dim oCajeroImp As COMNCajaGeneral.NCajeroImp
...
Private Sub cmdImprimir_Click()
    ...
    Set oCajeroImp = New COMNCajaGeneral.NCajeroImp
    Select Case lsKey
        Case "A1"
        ...
        Case "A3"
            ...
            lsTexto = lsTexto + Chr$(12) + oCajeroImp.GeneraRepoCompraVenta(gOpeCajeroMEVenta, Me.txtdesde, txthasta, txtBuscarUser, txtbuscarAge, _
                    gsNomCmac, gsNomAge, "AHORRO ", gdFecSis, gnColPage, gnLinPage)
...
Private Sub Form_Load()
    Dim oArea As COMDConstantes.DCOMActualizaDatosArea
    Dim oGen As COMDConstSistema.DCOMGeneral
    Set oGen = New COMDConstSistema.DCOMGeneral
    Set oArea = New COMDConstantes.DCOMActualizaDatosArea
