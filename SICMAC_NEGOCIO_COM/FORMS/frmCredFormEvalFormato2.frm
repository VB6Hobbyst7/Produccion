...
Begin VB.Form frmCredFormEvalFormato2 
   ...
   Begin TabDlg.SSTab SSTabIngresos 
      ...
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "fraBalanceGeneral2"
      Tab(0).Control(1).Enabled=   0   'False
      ...
      Begin VB.Frame Frame4 
         ...
         End
      End
      Begin VB.Frame fraBalanceGeneral2 
...
Private Sub Cmdguardar_Click()
    ...
    If ValidaDatos Then
        ...
        GrabarDatos = oNCOMFormatosEval.GrabarCredFormEvalFormato1_5(sCtaCod, fnFormato, fnTipoRegMant, _
                                                                    ...
                                                                    CDbl(txtExcedenteMensual.Text), , , , , , , fnColocCondi, , MatBalActCorr, MatBalActNoCorr, _
            ...
            If GrabarDatos Then
                fbGrabar = True
                    ...
                    If Not ValidaExisteRegProceso(sCtaCod, gTpoRegCtrlEvaluacion) Then
                       ...
                       'objPista.InsertarPista gsOpeCod, lcMovNro, gsCodPersUser, GetMaquinaUsuario, gInsertar, "Evaluacion Credito Formato 2", sCtaCod, gCodigoCuenta 'LUCV20181220 Comentó, Anexo01 de Acta 199-2018
                    ...
                    If fnTipoRegMant = 1 Then
                        objPista.InsertarPista gsOpeCod, lcMovNro, gsCodPersUser, GetMaquinaUsuario, gInsertar, "Evaluacion Credito Formato 2", sCtaCod, gCodigoCuenta 'LUCV20181220 Agregó, Anexo01 de Acta 199-2018
                        ...
                        End If
                    Else
                        objPista.InsertarPista gsOpeCod, lcMovNro, gsCodPersUser, GetMaquinaUsuario, gModificar, "Evaluacion Credito Formato 2", sCtaCod, gCodigoCuenta 'LUCV20181220 Agregó, Anexo01 de Acta 199-2018
                        Set objPista = Nothing 'LUCV20181220 Agregó, Anexo01 de Acta 199-2018
                        If Not fbImprimirVB Then
...
Private Sub txtColaterales2_KeyPress(KeyAscii As Integer) 'Colaterales_Garantias
    ...
    End If
End Sub
Private Sub txtDestino2_KeyPress(KeyAscii As Integer) 'Destino del crédito
    KeyAscii = SoloLetras3(KeyAscii, True)
    If KeyAscii = 13 Then
        SSTabIngresos.Tab = 2
...
Private Sub feGastosNegocio_OnClickTxtBuscar(psMontoIfiGastoNego As String, psDescripcion As String) 'GastosNegocio
    ...
    If feGastosNegocio.TextMatrix(feGastosNegocio.row, 1) = gCodCuotaIfiGastoNego Then 'CTI320200110 ERS003-2020. Agregó
        If psMontoIfiGastoNego = 0 Then
            ...
            frmCredFormEvalCuotasIfis.Inicio (CLng(feGastosNegocio.TextMatrix(feGastosNegocio.row, 3))), fnTotalRefGastoNego, MatIfiGastoNego, feGastosNegocio.TextMatrix(feGastosNegocio.row, 2), gFormatoGastosNego, gCodCuotaIfiGastoNego
...
Public Function Inicio(ByVal psTipoRegMant As Integer, ByVal psCtaCod As String, ByVal pnFormato As Integer, ByVal pnProducto As Integer, _
    ...
    If psCtaCod <> -1 Then '*****-> cCtaCod
        ...
        fnFormato = pnFormato
        SSTabIngresos.Tab = 0
        'frameLinea.Visible = False 'Para Ocultar Tab->Linea Credito Aut. 'CTI320200110 ERS003-2020, Comentó
        fbPermiteGrabar = False
        fbBloqueaTodo = False
        Else
...
On Error GoTo ErrorCargaDatos
    ...
    CargaDatos = oNCOMFormatosEval.CargaDatosCredEvaluacion2(sCtaCod, _
                                                            ...
                                                            rsDatIfiGastoNego, _
                                                            rsDatIfiGastoFami, _
                                                            rsDatVentaCosto, , , , , , , rsDatIfiBalActCorri, rsDatIfiBalActNoCorri, _
...
On Error GoTo ErrorCalculo
    ...
    Exit Sub
ErrorCalculo:
MsgBox "Información: Ingrese los datos Correctamente." & Chr(13) & "Detalles: " & Err.Description, vbInformation, "Informacion"
    Select Case pnTipo
        Case 1:
                txtIngresoNegocio.Text = "0.00"
                txtEgresoNegocio.Text = "0.00"
...
Private Function Registro()
    ...
    If fnProducto = "800" Then
        fraBalanceGeneral2.Visible = False
    End If
    'Fin CTI320200110
End Function
