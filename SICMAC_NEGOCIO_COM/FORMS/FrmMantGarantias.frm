...
Private Sub CmdAceptar_Click()
    Dim objMantGarant As COMDCredito.DCOMGarantia ' DMantGarantia
    If MSH.Rows > 1 Then
        CargarDataAActualizar
        Set objMantGarant = New COMDCredito.DCOMGarantia 'DMantGarantia
...
Sub CargarLstTpoGarantia()
    Dim objTpoGarantia As COMDCredito.DCOMGarantia 'DMantGarantia
    Dim rs As ADODB.Recordset
    Dim iListItem As ListItem
    
        Set objTpoGarantia = New COMDCredito.DCOMGarantia 'DMantGarantia
