...
oDoc.WTextBox 70, 50, 10, 750, "CONTROL DOCUMENTARIO DE CREDITOS", "F2", 12, hCenter
    ...
    If Not (rs.EOF And rs.BOF) Then
        'nEspCab = CInt(Len(rs!cPersNombre) / 37) * 10 'JOEP20191024_Mejora en espacio de letras
        nEspCab = IIf((CInt(Len(rs!cPersNombre) / 37) * 10) = 0, 10, (CInt(Len(rs!cPersNombre) / 37) * 10))
