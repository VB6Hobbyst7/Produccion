...
Begin VB.Form frmCredReporteCierreMes 
   ...
   Begin RichTextLib.RichTextBox RTF 
      ...
      _ExtentY        =   741
      _Version        =   393217
      TextRTF         =   $"frmCredReporteCierreMes.frx":0000
   End
      ...
      Begin MSComctlLib.ImageList imglstFiguras 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCredReporteCierreMes.frx":0082
               Key             =   "Padre"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCredReporteCierreMes.frx":039C
               Key             =   "Hijo"
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "frmCredReporteCierreMes"
...
Case 108801:
            ...
            lsRtfImpG = Co.nRepo108801_("dbCmactConsolidada..", Fechaini, Co.GEtFechaCierreMes, Val(TxtCambio))
...
Case 108803:
            If Not (IsNumeric(TxtCambio)) Then
                MsgBox "Ingrese Correctamente el Tipo de Cambio", vbInformation, "AVISO"
            Else
                lsRtfImpG = Co.nRepo108803_("dbCmactConsolidada..", Val(TxtCambio))
...
Case 108804:
            If Not (IsNumeric(TxtCambio)) Then
                MsgBox "Ingrese Correctamente el Tipo de Cambio", vbInformation, "AVISO"
            Else
                lsRtfImpG = Co.nRepo108804_("dbCmactConsolidada..", Val(TxtCambio))
