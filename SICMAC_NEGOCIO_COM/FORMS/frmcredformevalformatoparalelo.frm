...
Private Sub cmdActualizar_Click()
    ...
    If ValidarDatosFormatoParalelo Then
       ...
       ActualizarFormatoParalelo = oCredFormEval.ActualizarfrmCredFormEvalFormatoParalelo(sCtaCod, nFormato, CDate(txtFechaExpeCaja.Text), _
                                                                                          ...
                                                                                          'rsGastoNeg, rsGastoFam, MatIfiGastoNego, MatIfiGastoFami, MatIfiNoSupervisadaGastoNego, MatIfiNoSupervisadaGastoFami 'CTI320200110 ERS003-2020, Agregó
...
Private Sub cmdCancelar_Click()
    ...
    Set MatIfiGastoNego = Nothing 'CTI320200110 ERS003-2020. Agregó
    Set MatIfiGastoFami = Nothing 'CTI320200110 ERS003-2020. Agregó
...
Dim oDCOMFormatosEval As COMDCredito.DCOMFormatosEval
    ...
    'oDoc.WTextBox 180, 70, 1, 190, txtCapPago.Text, "F1", 7.5, hRight 'CTI320200110 ERS003-2020. Comentó
    oDoc.WTextBox 180, 70, 1, 190, txtCapacidadNeta, "F1", 7.5, hRight 'CTI320200110 ERS003-2020. Agregó
...
Private Sub feGastosNegocio_Click()
    If feGastosNegocio.col = 3 Then
        If CInt(feGastosNegocio.TextMatrix(feGastosNegocio.row, 1)) = gCodCuotaIfiGastoNego _
            Or (CInt(feGastosNegocio.TextMatrix(feGastosNegocio.row, 1)) = gCodCuotaIfiNoSupervisadaGastoNego) Then 'CTI320200110 ERS003-2020, Agregó
...
Private Sub feGastosNegocio_EnterCell()
    ...
    If feGastosNegocio.col = 3 Then
        If (CInt(feGastosNegocio.TextMatrix(feGastosNegocio.row, 1)) = gCodCuotaIfiGastoNego) _
        Or (CInt(feGastosNegocio.TextMatrix(feGastosNegocio.row, 1)) = gCodCuotaIfiNoSupervisadaGastoNego) Then 'CTI320200110 ERS003-2020, Agregó: gCodCuotaIfiNoSupervisadaGastoNego
            feGastosNegocio.ListaControles = "0-0-0-1-0"
        Else
            feGastosNegocio.ListaControles = "0-0-0-0-0"
        End If
