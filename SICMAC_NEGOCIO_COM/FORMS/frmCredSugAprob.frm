...
'*** Descripción : Formulario para registrar validacion expediente credito.
'*** Creación : MIOL el 20120802, según OYP-RFC065-2012
'********************************************************************
Option Explicit
...
Private Sub cmdSalObs_Click()
    ...
    MsgBox "Expediente Salio por Observación de Asesoria Legal", vbInformation, "Aviso"
