...
Begin VB.Form frmCapPlanBici 
   ...
   Begin VB.Frame FraDatos 
      ...
      Begin SICMACT.FlexEdit feCuotas 
         ...
         font            =   "frmCapPlanBici.frx":030A
         font            =   "frmCapPlanBici.frx":0336
         font            =   "frmCapPlanBici.frx":0362
         font            =   "frmCapPlanBici.frx":038E
         font            =   "frmCapPlanBici.frx":03BA
         fontfixed       =   "frmCapPlanBici.frx":03E6
      ...
      Begin VB.ComboBox cboTipoPago 
         Height          =   315
         ItemData        =   "frmCapPlanBici.frx":0440
         Left            =   5850
         List            =   "frmCapPlanBici.frx":0442
   ...
   Begin VB.Frame fraCredito 
      ...
      Begin VB.Frame FraListaCred 
         ...
         Begin VB.ListBox LstCred 
            Height          =   645
            ItemData        =   "frmCapPlanBici.frx":0444
            Left            =   75
            List            =   "frmCapPlanBici.frx":0446
            TabIndex        =   9
            Top             =   225
            Width           =   2535
         End
   ...
   End
End
Attribute VB_Name = "frmCapPlanBici"
...
If MsgBox("Se va a Efectuar el Pago del PLAN BICI, Desea Continuar ?", vbInformation + vbYesNo, "Aviso") = vbYes Then
    ...
    oGraba.CapPagoPLANBICI lsCodCta, PlanPagos, txtTotal, lnCuotasPag, cboTipoPago.ListIndex, lsMovNro, lblCalendario, lnCuotaPagPJ
...
Private Sub BuscaPlanBici(ByVal psCodCta As String)
...
Set rs = oDatos.dGetDatosPlanBici(psCodCta)
...
Set rs = oDatos.dGetDatosPlanBiciDet(psCodCta)
