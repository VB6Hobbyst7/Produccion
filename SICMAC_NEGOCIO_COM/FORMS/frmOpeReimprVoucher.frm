...
Private Sub cmdReimprimir_Click()
    ...
    For i = 0 To UBound(ImprDesemb) - 1
        If ImprDesemb(i, 0) = "1" Then 'Para Boleta
    ...
    Case "310101", "310301"
        ...
        If psOpeCod = "310101" Then
            sImpreBoleta = oImpCapServ.ImprimeBoletaGiros(rsDatos!cCtaCod, rsDatos!cRemitente, sDest(), rsDatos!nMonto, rsDatos!nComision, gdFecSis, Format$(Time, "hh:mm:ss"), gsNomAge, gsCodUser, sLpt, , 0, rsDatos!cagedest, gbImpTMU)
        ElseIf psOpeCod = "310301" Then
            sImpreBoleta = oImpCapServ.ImprimeBoletaCancelacionGiros(rsDatos!cCtaCod, rsDatos!cRemitente, sDest(), rsDatos!nMonto, gdFecSis, Format$(Time, "hh:mm:ss"), gsNomAge, gsCodUser, sLpt, , gbImpTMU)
...
'CREDITO PIGNORATICIOç
'    DESEMBOLSO  lsCadImp    NCOMColPImpre.nPrintReciboDesembolso
'    AMORTIZACION    lsCadImprimir   NCOMColPImpre.nPrintReciboAmortizacion

'    CANCELACION lsCadImprimir   NCOMColPImpre.nPrintReciboCancelacion
'    CUSTODIA DIF.   lsCadImprimir   NCOMColPImpre.nPrintReciboCobroCustodia
'    REMATE      lsCadImp    COMNColoCPig.ImprimirComision
'    PAGO SOBRANTE   lsCadImprimir   NCOMColPImpre.nPrintReciboPagoSobrante
'    VENTA JOYAS lsCadImp    NCOMColPImpre.ImpRecVtaSub
'    RECUP CONTRATO  lsCadImp    NCOMColPImpre.ImpRecupSub
'
'AHORROS/PLAZO FIJO/CTS
'    APERTURAS LOTE  lsCadImp    For NCOMCaptaMovimiento.ImprimeBoleta Next
'    DEPOSITOS LOTE  lsBoleta    NCOMCaptaImpresion.ImprimeBoleta
'    CANCELACIONES   lsBoleta    NCOMCaptaMovimiento.ImprimeBoletaInteres
'    RETIRO INT. PF  lsBoleta    NCOMCaptaMovimiento.ImprimeBoleta
'    CANCELACION PF  lsBoleta    NCOMCaptaMovimiento.ImprimeBoletaInteres
'    DISM. CAP. PF   lsBoleta    NCOMCaptaMovimiento.ImprimeBoletaInteres
'GIROS
'    APERTURAS       lsBoleta    NCOMCaptaServicios.ImprimeBoletaGiros
'    CANCELACIONES   lsBoleta    NCOMCaptaServicios.ImprimeBoletaCancelacionGiros
'
'COMPRA/VENTA ME
'            lsBoleta NCOMContImprimir.ImprimeBoletaCompraVenta
...
'    End If
    ...
    If MsgBox("Se va a reimprimir el voucher, Desea Continuar?", vbInformation + vbYesNo, "Aviso") = vbNo Then Exit Sub
