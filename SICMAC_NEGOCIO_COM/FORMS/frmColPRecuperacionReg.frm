    ...
    If (nEstadoCamp = 1) Then
         Do
            ...
            ElseIf IsNumeric(sResultModal) Then
                If CDbl(sResultModal) > CInt(sResultModal) Then
         ...
         Loop While (Trim(sResultModal) = "") Or (nPorcDesc < 0 And nPorcDesc > 100) Or (CDbl(sResultModal) > CInt(sResultModal)) Or (sResultModal > rsBusca!nPorcMax)
...
If MsgBox(" Grabar Venta de Joyas Adjudicadas ? ", vbYesNo + vbQuestion + vbDefaultButton1, " Aviso ") = vbYes Then
        ...
        Set loGrabarVta = New COMNColoCPig.NCOMColPContrato
            ...
            Call loGrabarVta.nSubastaVentaCredPignoraticioSINSubasta(AXCodCta.NroCuenta, fsVarNroSubasta, lsFechaHoraGrab, _
                 ...
                 , True, , lnMovNroResult, lnPreVta, lnDevol, CCur(Val(Me.txtDsctoInt.Text)))
...
If IsNumeric(txtPreVentaBruta.Text) Then
     ...
     If gITF.gbITFAplica Then
        ...
        If Not gITF.gbITFAsumidocreditos Then
            'Me.TxtMontoTotal.Text = "0.00"
              ...
              '  End If
                 ...
                 TxtItf.Text = Format(gITF.fgITFCalculaImpuesto(Me.txtPreVentaBruta.Text))  'PEAC 20200828
                 '*** BRGO 20110908 ************************************************
        ...
        Else
                 ...
                 Me.TxtItf = gITF.fgITFCalculaImpuesto(Me.txtPreVentaBruta.Text)  'PEAC 2020828 se agregó Me.txtDsctoInt.Text
