...
Private Sub cmdExtornar_Click()
    ...
    If MsgBox("¿Esta seguro de extornar las confirmaciones de remesas seleccionadas?", vbYesNo + vbQuestion, "Aviso") = vbNo Then Exit Sub
    
    Screen.MousePointer = 11
    cmdExtornar.Enabled = False
    Set oCaja = New COMNCajaGeneral.NCOMCajaGeneral
    lbExito = oCaja.ExtornaConfirmacionRemesa(Datos, gdFecSis, Right(gsCodAge, 2), gsCodUser, gsOpeCod, Trim(txtGlosa.Text))
