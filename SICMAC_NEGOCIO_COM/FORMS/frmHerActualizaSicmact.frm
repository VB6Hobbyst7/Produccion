...
'Dim lsUserInstall As String
'Dim lsPasswordInstall  As String
...
'                ProgressBar.value = CopyFile(Filepath.Text, Destinationpath.Text)
'                '**** Lo registra
'                Dim oRun As clsRunAs
'                Set oRun = New clsRunAs
'
'                oRun.sDomain = ""
'                oRun.sUserName = lsUserInstall
'                oRun.sPassword = lsPasswordInstall
'                oRun.sCommand = "regsvr32  /s " & """" & Trim(Destinationpath.Text) & """"
'                oRun.RunAs
'
'                Set oRun = Nothing
'                'retval = Shell("regsvr32 /s " & fi.name)
'
'                '**************
'             End If
'          End If
...
'
'Unload Me
'MsgBox " SE HA ACTUALIZADO EL SISTEMA " & oImpresora.gPrnSaltoLinea & "Debe volver a Ingresar al Sicmact", vbInformation, "Aviso"
'
'Exit Sub
'ErrActualiza:
...
'End Sub
'Sub GetDatosUserInstall()
'Dim oCon As NConstSistemas
'Dim oEncript As cEncrypt
'Set oEncript = New cEncrypt
'
'Set oCon = New NConstSistemas
'lsUserInstall = oCon.LeeConstSistema(200)
'lsPasswordInstall = oCon.LeeConstSistema(201)
'lsPasswordInstall = oEncript.DesEncriptar(lsPasswordInstall, "")
'
'
'Set oCon = Nothing
'
