...
Begin VB.Form frmCredSugerencia_NEW 
   ...
   Begin ComctlLib.ProgressBar pbCargaSugerencia 
      Height          =   200
      Left            =   120
      TabIndex        =   201
      Top             =   0
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(4)=   "feDeudaComprar"
      ...
      Begin VB.Frame FraDatos 
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VB.ComboBox cmbTipoPer 
               Height          =   315
               ItemData        =   "frmCredSugerencia_NEW.frx":0407
               Left            =   120
               List            =   "frmCredSugerencia_NEW.frx":0411
         ...
         Begin VB.Frame Frame3 
            ...
            Begin SICMACT.TxtBuscar txtBuscarLinea 
               ...
               appearance      =   1
               appearance      =   1
               font            =   "frmCredSugerencia_NEW.frx":0464
               appearance      =   1
            End
         ...
         Begin VB.Frame Frame10 
            ...
            Begin SICMACT.EditMoney txtMonSug 
               ...
               _extentx        =   2302
               _extenty        =   556
               font            =   "frmCredSugerencia_NEW.frx":0490
               text            =   "0"
               enabled         =   -1  'True
            End
         ...
         Begin VB.Frame fratipodes 
            ...
            Begin VB.ComboBox cmbDesemb 
               Height          =   315
               ItemData        =   "frmCredSugerencia_NEW.frx":04BC
               Left            =   120
               List            =   "frmCredSugerencia_NEW.frx":04C6
               Style           =   2  'Dropdown List
               TabIndex        =   186
               Top             =   240
               Width           =   1335
         ...
         Begin VB.Frame FraCalendario 
            ...
            Begin VB.ComboBox cmbTipoCalend 
               Height          =   315
               ItemData        =   "frmCredSugerencia_NEW.frx":0510
               Left            =   120
               List            =   "frmCredSugerencia_NEW.frx":051A
               Style           =   2  'Dropdown List
               TabIndex        =   187
               Top             =   240
               Width           =   1095
         ...
         Begin VB.Frame FraTipoCuota 
            ...
            Begin VB.ComboBox cmbTipoCuota 
               Height          =   315
               ItemData        =   "frmCredSugerencia_NEW.frx":055E
               Left            =   120
      ...
      Begin VB.Frame fraVinculosEmpresas 
         ...
         Begin SICMACT.FlexEdit grdEmpVinculados 
            ...
            font            =   "frmCredSugerencia_NEW.frx":0607
            font            =   "frmCredSugerencia_NEW.frx":0633
            font            =   "frmCredSugerencia_NEW.frx":065F
            font            =   "frmCredSugerencia_NEW.frx":068B
            font            =   "frmCredSugerencia_NEW.frx":06B7
            fontfixed       =   "frmCredSugerencia_NEW.frx":06E3
            lbultimainstancia=   -1  'True
            tipobusqueda    =   3
      ...
      Begin VB.Frame Frame6 
         ...
         Begin SICMACT.EditMoney txtTasacion 
            ...
            _extentx        =   2143
            _extenty        =   503
            font            =   "frmCredSugerencia_NEW.frx":0711
            appearance      =   0
            text            =   "0.00"
            enabled         =   -1  'True
         End
      ...
      Begin VB.Frame fraOpGarantia 
         ...
         Begin SICMACT.TxtBuscar txtCtaGarantia 
            ...
            appearance      =   1
            appearance      =   1
            font            =   "frmCredSugerencia_NEW.frx":073D
            appearance      =   1
            editflex        =   -1  'True
         End
         Begin SICMACT.EditMoney txtMontoGarantia 
            ...
            _extentx        =   2143
            _extenty        =   503
            font            =   "frmCredSugerencia_NEW.frx":0769
            appearance      =   0
            text            =   "0.00"
            enabled         =   -1  'True
         End
...
'JOEP20181001 CP ERS042 - 2018
Dim lsTpoCredCodCombo As String 'CTI3 ERS0032020
Dim lbSugerenciaCargado As Boolean 'CTI3 ERS0032020
Dim pbTechoPropio As Boolean 'CTI3 ERS0032020
Dim lsCtaCodAbono As String 'CTI3 ERS0032020
Dim nContratoId As Integer 'CTI3 ERS0032020
Dim nTpoBienContrato As Integer 'CTI3 ERS0032020
...
'WIOR  FIN***********************************************************************************************
    ...
    If NecesitaFormatoEvaluacion(ActxCta.NroCuenta, 2001, CInt(Left(sSTipoProdCod, 1) & "00"), CInt(sSTipoProdCod), fnMontoExpEsteCred_NEW, fbEliminarEvaluacion, , , Trim(Right(cmbTipoCredito.Text, 3)), 0) Then
        ValidaDatosGrabar = False
        Exit Function
    End If
    'END EJVG *******
...
'CTI520210428 ***
If Len(Trim(actxCtaAho.NroCuenta)) = 18 Then
        Dim clsDef As New COMNCaptaGenerales.NCOMCaptaDefinicion
        Dim clsCaptaGene As New COMNCaptaGenerales.NCOMCaptaGenerales
        Dim oRsCG As ADODB.Recordset
        Set oRsCG = New ADODB.Recordset
        Set oRsCG = clsCaptaGene.GetDatosCuenta(actxCtaAho.NroCuenta)

        If actxCtaAho.Prod = gCapAhorros Then
                If Not (oRsCG.BOF Or oRsCG.EOF) Then
                    If Not fbMIVIVIENDA Then
                        If oRsCG!nPrdEstado <> gCapEstActiva Then
                            MsgBox "La cuenta solicitada no está activa. Favor de comunicarse con el Departamento de Operaciones y Canales.", vbInformation, "Aviso"
                            ValidaDatosGrabar = False
                            Exit Function
                        End If
                    Else
                        If Not (oRsCG!nPrdEstado = gCapEstActiva Or oRsCG!nPrdEstado = gCapEstBloqRetiro) Then
                            MsgBox "La cuenta solicitada debe estar con estado activa o como bloqueo retiro. Favor de comunicarse con el Departamento de Operaciones y Canales.", vbInformation, "Aviso"
                            ValidaDatosGrabar = False
                            Exit Function
                        End If
                    End If
                
                    If Not clsDef.GetCapParametroNew(gCapAhorros, oRsCG!nTpoPrograma, actxCtaAho.NroCuenta)!bAplicaDesembCred Then
                            MsgBox "La cuenta de ahorro seleccionada no está configurado para destino de desembolso. Favor de comunicarse con el Departamento de Operaciones y Canales.", vbInformation, "Aviso"
                            ValidaDatosGrabar = False
                            Exit Function
                    End If
                Else
                        MsgBox "La cuenta de Ahorro no existe.", vbInformation, "Aviso"
                        ValidaDatosGrabar = False
                        Exit Function
                End If
        Else
                 MsgBox "La cuenta no es un producto de Ahorro.", vbInformation, "Aviso"
                 ValidaDatosGrabar = False
                Exit Function
        End If
End If
...
'End If '** END JUEZ
    ...
    If IsArray(MatCalend) Then
        If UBound(MatCalend, 1) = 1 Then
            lnMontoCuota = CDbl(MatCalend(0, 2)) 'CDbl(MatCalend(0, 3)) + CDbl(MatCalend(0, 4)) + CDbl(MatCalend(0, 5)) + CDbl(MatCalend(0, 6))
        Else
            lnMontoCuota = CDbl(MatCalend(1, 2)) 'CDbl(MatCalend(1, 3)) + CDbl(MatCalend(1, 4)) + CDbl(MatCalend(1, 5)) + CDbl(MatCalend(1, 6))
        End If
    ...
    If fbMIVIVIENDA Then
        If IsArray(fArrMIVIVIENDA) Then
           If Trim(fArrMIVIVIENDA(0)) <> "" Then
                 ...
                 objPista.InsertarPista gsOpeCod, GeneraMovNro(gdFecSis, gsCodAge, gsCodUser), gsCodPersUser, GetMaquinaUsuario, gInsertar, "Registro de Datos MIVIVIENDA", ActxCta.NroCuenta, gCodigoCuenta 'CTI3 ERS001-2020
          End If
        End If
    End If
    '************************************************
...
'JOEP ERS007-2018 20180210
    ...
    If Trim(Right(cmbTipoPer.Text, 2)) = "1" And (Trim(TxtDiaFijo.Text) = "" Or Trim(TxtDiaFijo.Text) = "0" Or Trim(TxtDiaFijo.Text) = "00") Then
        ...
        EnfocaControl txtFechaFija 'MAVM 25102010
        Exit Function
    End If
...
'Dim oCal As COMDCredito.DCOMCalendario
 Dim oBloqueo As UBloqueo 'CTI6-20210503-ERS032-2019 -(Optimizar Sugerencia)
...
Dim rsCtaBienFuturo As ADODB.Recordset 'CTI5 ERS012021
    ...
    Set oBloqueo = New UBloqueo
    pbCargaSugerencia.Min = 0
    pbCargaSugerencia.Max = 10
    pbCargaSugerencia.value = 2
    pbCargaSugerencia.Visible = True
    
    oBloqueo.ShowForm frmCredSugerencia_NEW, True
   
    bPermiteSugerencia = ofrmSolicitud.ValidarScore(psCtaCod, MatCredRelaciones, 2) 'add by marg 201906
    
    pbCargaSugerencia.value = pbCargaSugerencia.value + 2
    
    oBloqueo.CloseForm frmCredSugerencia_NEW
    'Fin CTI6-20210503
...
'******************************************************************
    ...
    Call oNCredito.CargaDatosSugerencia(psCtaCod, nOpcion, Mid(ActxCta.NroCuenta, 6, 3), Mid(ActxCta.NroCuenta, 9, 1), bValidaSugerencia, rsSuger, _
                                        ...
                                        nMicroseguro, nMultiriesgo, rsDatCredEval, fbEsAmpliado, rsCtaBienFuturo) 'DAOR 20071207, se agregó rsRepDesgrav
    ...
    pbCargaSugerencia.value = pbCargaSugerencia.value + 2 'CTI6-20210503-ERS032-2019 -(Optimizar Sugerencia)
    'INICIO EAAS20191401 SEGUN 018-GM-DI_CMACM
    ...
    If Not rsSuger.BOF And Not rsSuger.EOF Then
        ...
        TxtMora.Text = "0.00000"
        lblMora.Caption = "0.00000"
        nMostrarLineaCred = 1
...
'Catalogo JOEP
        ...
        'CTI3 ERS0032020*******************************************************************************
        lsTpoCredCodCombo = IIf(IsNull(rsSuger!nTipoCredCod), "0", CStr(rsSuger!nTipoCredCod))
        '**********************************************************************************************
...
'        Call CambiaTamañoCombo(Cmblincre, 300)
        ...
        End If
        If TxtMora.Visible Then
            'TxtMora.Text = Format(nTasaMora, "#0.00")'Comento JOEP20210810
            TxtMora.Text = Format(nTasaMora, "#0.00000") 'Add JOEP20210810
        End If
...
'            Dim nComisionEC As Double
    ...
    'CTI3 ERS0032020***********************************************
    Dim lsDocTpoBF As String
    pbTechoPropio = False
    lsCtaCodAbono = ""
    nContratoId = 0
    nTpoBienContrato = 0
    If Not (rsCtaBienFuturo.BOF Or rsCtaBienFuturo.EOF) Then
        If rsCtaBienFuturo!nTpoBienContrato = gTpoBienFuturo And rsCtaBienFuturo!cTpoProdCod = "802" Then
            pbTechoPropio = True
            lsCtaCodAbono = rsCtaBienFuturo!cCtaCod
            nContratoId = rsCtaBienFuturo!nContratoId
            nTpoBienContrato = rsCtaBienFuturo!nTpoBienContrato
            lsDocTpoBF = rsCtaBienFuturo!cTpoDoc
        End If
    End If
    If pbTechoPropio And nTpoBienContrato = gTpoBienFuturo And lsDocTpoBF = "161" Then
        actxCtaAho.Enabled = False
        actxCtaAho.Age = Mid(lsCtaCodAbono, 4, 2)
        actxCtaAho.Cuenta = Mid(lsCtaCodAbono, 9, 10)
        actxCtaAho.Prod = Mid(lsCtaCodAbono, 6, 3)
        actxCtaAho.CMAC = Mid(lsCtaCodAbono, 1, 3)
        cmdCtaAho.Enabled = False
        cmdVerTercero.Enabled = False
    Else
        actxCtaAho.Enabled = True
        cmdCtaAho.Enabled = True
        actxCtaAho.CMAC = ""
        actxCtaAho.Age = ""
        actxCtaAho.Cuenta = ""
        actxCtaAho.Prod = ""
        lsCtaCodAbono = ""
        cmdVerTercero.Enabled = True
    End If
    
    pbCargaSugerencia.value = pbCargaSugerencia.value + 2 'CTI6-20210503-ERS032-2019 -(Optimizar Sugerencia)
    pbCargaSugerencia.Visible = False  'CTI6-20210503-ERS032-2019 -(Optimizar Sugerencia)
    Set oBloqueo = Nothing
    '****************************************************************
    lblSolModif.Enabled = False 'LUCV20180601, Agregó según ERS022-2018
    Screen.MousePointer = vbDefault 'LUCV20180601, Agregó según ERS022-2018
    lbSugerenciaCargado = True
    Exit Function
...
'End Sub
'*****************************************************
Private Sub verificaCoorporativo(ByRef sretorno As String)
    'CTI3-ERS0032020
    Dim oDCreditos As COMDCredito.DCOMCreditos
    Dim rsTipCred As ADODB.Recordset
    Set rsTipCred = New ADODB.Recordset
    Set oDCreditos = New COMDCredito.DCOMCreditos
    Set rsTipCred = oDCreditos.ObtieneTipoCredito(ActxCta.NroCuenta)
    If Not (rsTipCred.EOF And rsTipCred.BOF) Then
        If Right(Trim(IIf(IsNull(rsTipCred!cTpoCredCod), "0", rsTipCred!cTpoCredCod)), 1) = 0 Then
            If MsgBox("Este crédito puede ser Coorporativo o Grande Empresa y necesitaría los EEFF actualizados. ¿Desea continuar sin ingresar los datos?", vbInformation + vbYesNo, "Aviso") = vbNo Then
    ...
    sretorno = "OK"
    RSClose rsTipCred
    oDCreditos.ReclasificaCategoriaCredito (ActxCta.NroCuenta)
End Sub
...
'            Call verificaCoorporativo(sRetorno)
'            If sRetorno = "" Then
'                Exit Sub
'            End If
            Dim oDCreditos1 As COMDCredito.DCOMCreditos
            Set oDCreditos1 = New COMDCredito.DCOMCreditos
            oDCreditos1.ReclasificaCategoriaCredito (ActxCta.NroCuenta)
            lbSugerenciaCargado = False
            'END ********************************
...
ReDim MatrizCal(0, 0)
    ...
    If RLinea!nTasaMoraIni <> RLinea!nTasaMoraFin Then
        ...
        lblMora.Enabled = False
        lblMora.Visible = False
        'TxtMora.Text = Format(IIf(IsNull(RLinea!nTasaMoraIni), 0, RLinea!nTasaMoraIni), "#0.0000")'JOEP20210810 Comento
        TxtMora.Text = Format(IIf(IsNull(RLinea!nTasaMoraIni), 0, RLinea!nTasaMoraIni), "#0.00000") 'Add JOEP20210810
        If Not IsNull(RLinea!nTasaMoraIni) Then
            TxtMora.ToolTipText = "Minima : " & Format(RLinea!nTasaMoraIni, "#0.00000") & "  Maxima : " & Format(RLinea!nTasaMoraFin, "#0.00000")
        End If
    Else
        TxtMora.Visible = False
        TxtMora.Enabled = False
        ...
        lblMora.Visible = True
        'LblMora.Caption = Format(IIf(IsNull(RLinea!nTasaMoraIni), 0, RLinea!nTasaMoraIni), "#0.0000")'JOEP20210810 Comento
        lblMora.Caption = Format(IIf(IsNull(RLinea!nTasaMoraIni), 0, RLinea!nTasaMoraIni), "#0.00000") 'Add JOEP20210810
    End If
End Sub
...
Private Sub CmdGrabar_Click()
    Dim sValor As String
    Dim oBloqueo As UBloqueo 'CTI6-20210503-ERS032-2019 -(Optimizar Sugerencia)
    Set oBloqueo = New UBloqueo 'CTI6-20210503-ERS032-2019 -(Optimizar Sugerencia)
    oBloqueo.ShowForm frmCredSugerencia_NEW, True 'CTI6-20210503-ERS032-2019 -(Optimizar Sugerencia)
   
    If Not ValidaDatosGrabar(sValor) Then
        oBloqueo.CloseForm frmCredSugerencia_NEW 'CTI6-20210503-ERS032-2019 -(Optimizar Sugerencia)
        Set oBloqueo = Nothing 'CTI6-20210503-ERS032-2019 -(Optimizar Sugerencia)
        Exit Sub
    End If
...
Private Sub txtMora_LostFocus()
    If Trim(TxtMora.Text) = "" Then
        TxtMora.Text = "0.00000"
    Else
        TxtMora.Text = Format(TxtMora.Text, "#0.00000")
    End If
End Sub
...
Private Sub txtmonsug_LostFocus()
    ...
    End If
    bEntrotxtMontoSeg = False   'JOEP20190129 CP
    'EnfocaControl spnCuotas    'ANGC20210818 Comentado
End Sub
...
'End Sub
'<-***** Fin LUCV20180601
Private Sub ObtenerFormatoEvaluacion(ByRef bBorrarFormato As Boolean)
    If Len(ActxCta.NroCuenta) <> "18" Then
        Exit Sub
    End If
    ...
    nFormEmpr = False
'*********************************************************************
    Call EvaluarCredito(ActxCta.NroCuenta, False, nEstado, CInt(Mid(sSTipoProdCod, 1, 1) & "00"), CInt(sSTipoProdCod), fnMontoExpEsteCred_NEW, False, , nFormEmpr, True, bBorrarFormato)
    End Sub
Private Sub cmbTipoCredito_Click()
    ...
    Dim oDCreditos As COMDCredito.DCOMCreditos
    Dim lbBorrarFormato As Boolean
    Set oDCreditos = New COMDCredito.DCOMCreditos
    Set rsCred = oEval.RecuperaFormatoEvaluacion(ActxCta.NroCuenta)
    If Not (rsCred.EOF And rsCred.BOF) Then
        nFormato = rsCred!nCodForm
    End If

    If Trim(lsTpoCredCodCombo) <> "" And Trim(Right(cmbTipoCredito.Text, 3)) <> Trim(lsTpoCredCodCombo) And lbSugerenciaCargado = True And nFormato > 0 Then
        Call ObtenerFormatoEvaluacion(lbBorrarFormato)
        If lbBorrarFormato = True Then
            If MsgBox("Al cambiar el tipo de crédito se eliminará el formato de evaluación. Desea continuar?", vbInformation + vbYesNo, "Aviso") = vbNo Then
                cmbTipoCredito.ListIndex = IndiceListaCombo(cmbTipoCredito, Trim(lsTpoCredCodCombo))
                Exit Sub
            End If
        End If
    End If
    
    If lbBorrarFormato = True And Trim(Right(cmbTipoCredito.Text, 3)) <> Trim(lsTpoCredCodCombo) And lsTpoCredCodCombo <> "" And Trim(Right(cmbTipoCredito.Text, 3)) <> "" And lbSugerenciaCargado = True Then
      
        If nFormato > 0 Then
            oEval.EliminaFormatoEvaluacion (ActxCta.NroCuenta)
            MsgBox "Se ha eliminado la actual Evaluación del Crédito", vbInformation, "Aviso"
        End If
        
        Call oDCreditos.ActualizaCategoriaCredito(ActxCta.NroCuenta, Trim(Right(cmbTipoCredito.Text, 3)))
    End If
    lsTpoCredCodCombo = Trim(Right(cmbTipoCredito.Text, 3))
    '*************************************************************************************************
...
If fbDatosCargados Then
    If fbMIVIVIENDA Then
        Call frmCredMiViviendaDatos.Inicio(Trim(ActxCta.NroCuenta), fArrMIVIVIENDA, Right(cmbSubTipo.Text, 3), Right(cmbDestino.Text, 3)) 'JGPA20201118 - Added [Right(cmbSubTipo.Text, 3), Right(CmbDestino.Text, 3)]
        If IsArray(fArrMIVIVIENDA) Then
