...
Private Sub CargaUbicacionesGeograficas_ANT()
...
Private Sub CmdAceptar_Click()
    If Len(Trim(cmbPersUbiGeo(3).Text)) = 0 Then
        MsgBox "Seleccione Una Zona", vbInformation, "Aviso"
        Exit Sub
    End If
    If cmbPersUbiGeo(3).Text = "TODOS" Then
        sCodUbicacion = cmbPersUbiGeo(2).Text
    Else
...
Set oUbic = New COMDPersona.DCOMPersonas
Set R = oUbic.CargarUbicacionesGeograficas(, 1)
Set oUbic = Nothing

While Not R.EOF
    cmbPersUbiGeo(0).AddItem Trim(R!cUbiGeoDescripcion) & Space(50) & Trim(R!cUbiGeoCod)
    R.MoveNext
Wend
