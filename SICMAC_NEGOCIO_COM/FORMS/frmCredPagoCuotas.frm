...
'    Set oSeguridad = Nothing
    ...
    'INICIO JIPR 20180625
     ...
     Set R = oCredCodFactElect.VerificaInteresFactElect(gnMovNro)
     ...
     Set R = oCredCodFactElect.RecuperaFactElectDetalle(ActxCta.NroCuenta)
        If R.RecordCount > 0 Then
         ...
         Set R = oCredCodFactElect.GenerarCorrelativo(scPersIDTpo, gsCodAge)
                If R.RecordCount > 0 Then
                    If Not (R.BOF And R.EOF) Then
         sSerie = R!cSerie
         sCorrelativo = R!cNro
         ...
         Call oCredCodFactElect.InsertarRegVentaFactElect(gdFecSis, scPersCod, ActxCta.NroCuenta, gnMovNro, IIf(nmoneda = 1, 1, 2), gsCodAge)
            ...
            MsgBox "Coordinar con el Supervisor de Operaciones, para la Emisión de Facturación Electrónica del Pago de Crédito.", vbInformation, "Aviso"
