...
Begin VB.Form frmCredReporteFinMes 
   ...
   Begin RichTextLib.RichTextBox RTF 
      ...
      _ExtentY        =   741
      _Version        =   393217
      TextRTF         =   $"frmCredReporteFinmes.frx":0000
   End
      ...
      Begin MSComctlLib.ImageList imglstFiguras 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCredReporteFinmes.frx":0082
               Key             =   "Padre"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCredReporteFinmes.frx":039C
               Key             =   "Hijo"
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "frmCredReporteFinmes"
...
Case 108701:
         ...
         Else
            ...
            P.Show lsRtfImpG, "Situacion de Cartera Colocaciones x Moneda", True, , gImpresora
         End If
Case 108702:
        lsRtfImpG = ""
...
Case 108703:
        ...
        Else
           ...
           P.Show lsRtfImpG, "Resumen por Producto y Vencimiento  (A-2.1)", True, , gImpresora
        End If
Case 108704: '  Reporte por  Producto  Y Agencia (A-2.3)
         ...
         Else
           ...
           P.Show lsRtfImpG, "Reporte por  Producto  Y Agencia (A-2.3)", True, , gImpresora
         End If
...
Case 108705: 'Reporte para Reclasificacion de Cartera (A-4)
        ...
        lsRtfImpG = Co.nRepo108705_ImpCarteraReclasificacion(IIf(optPlanActual.value = True, "1", "2"), "dbCmactConsolidada..")
         ...
         Else
           ...
           P.Show lsRtfImpG, "Reporte para Reclasificacion de Cartera (A-4)", True, , gImpresora
         End If
...
Case 108706: ' Reporte de Intereses Devengados Vigentes (A-5)
         ...
         Else
           ...
           P.Show lsRtfImpG, "Reporte de Intereses Devengados Vigentes (A-5)", True, , gImpresora
         End If
Case 108707: ' Reporte de Intereses Devengados Vencidos y Cobranza Judicial (A-6)
         ...
         Else
           ...
           P.Show lsRtfImpG, "Reporte de Intereses Devengados Vencidos y Cobranza Judicial (A-6)", True, , gImpresora
         End If
...
Case 108711: ' Reporte de Intereses de Créditos (A-4)
            ...
            Else
                ...
                P.Show lsRtfImpG, "Reporte de Intereses de Créditos (A-4)", True, , gImpresora
            End If
Case 108801:
            ...
            P.Show lsRtfImpG, "INFO1", True, , gImpresora
...
Case 108802:
            ...
            Else
                ...
                P.Show lsRtfImpG, "INFO2", True, , gImpresora
            End If
...
Case 108803:
            ...
            Else
                ...
                P.Show lsRtfImpG, "INFO3", True, , gImpresora
            End If
...
Case 108804:
            ...
            Else
                ...
                P.Show lsRtfImpG, "INFO4", True, , gImpresora
            End If
...
Case 108806:
            ...
            Else
                ...
                P.Show lsRtfImpG, "INFO6", True, , gImpresora
            End If
