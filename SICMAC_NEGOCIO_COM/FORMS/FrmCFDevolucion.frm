VERSION 5.00
Begin VB.Form FrmCFDevolucion 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Carta Fianza -Devolución de CF Emitida"
   ClientHeight    =   5640
   ClientLeft      =   2265
   ClientTop       =   1845
   ClientWidth     =   7665
   Icon            =   "FrmCFDevolucion.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5640
   ...
   End
End
Attribute VB_Name = "FrmCFDevolucion"
...
'*************************************************************************
'*  RESUMEN: DEVOLUCION CARTA FIANZA EMITIDA
'***************************************************************************
...
Dim lsCta As String
    ...
    lsCta = frmCFPersEstado.Inicio(Array(gColocEstVigNorm), "Devolucion de Carta Fianza Emitida", Array(gColCFComercial, gColCFPYME, gColCFTpoProducto))
...
If MsgBox("Desea Grabar Devolución de Carta Fianza Emitida", vbInformation + vbYesNo, "Sugerencia de Analista") = vbYes Then
    ...
    Set loNCartaFianza = New COMNCartaFianza.NCOMCartaFianza
        Call loNCartaFianza.nCFDevolucion(vCodCta, lsFechaHoraGrab, lsMovNro, lsComenta, lnDevuelta, lnMonto)
        objPista.InsertarPista gsOpeCod, lsMovNro, gsCodPersUser, GetMaquinaUsuario, gInsertar, "Devolver CF Emitida", vCodCta, gCodigoCuenta
...
Private Sub Form_Load()
    ...
    gsOpeCod = gCredDevolverCFEmitida
End Sub
