VERSION 5.00
Begin VB.Form frmBuscaPersFideicomiso 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Busca Persona"
   ClientHeight    =   2655
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7470
   Icon            =   "frmBuscaPersFideicomiso.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
   ...
   End
End
Attribute VB_Name = "frmBuscaPersFideicomiso"
...
Set oDatos = New COMDCaptaServicios.DCOMCaptaFideicomiso
    ...
    Set rs = oDatos.dGetCuentasFideicomiso(fePersonas.TextMatrix(fePersonas.Row, 1))
    
    If Not rs.EOF And Not rs.BOF Then
        Do While Not rs.EOF
            frmCapFideicomiso.LstCred.AddItem rs!cCtaCod
