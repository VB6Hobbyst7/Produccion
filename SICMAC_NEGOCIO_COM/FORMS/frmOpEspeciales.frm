...
Public Sub Ini(psOpeCod As COMDConstantes.CaptacOperacion, psCaption As String)
    ...
    If gOtrOpeAhoOtrosEgresos = lsOpeCod Then
        ...
        sMovNroAut = ""
        Dim loVistoElectronico As New SICMACT.frmVistoElectronico
...
'''   'END MADM
    ...
    If MsgBox("Desea Grabar la Información", vbQuestion + vbYesNo, "Aviso") = vbYes Then
        ...
        Dim loLavDinero As SICMACT.frmMovLavDinero
        ...
        Set loLavDinero = New SICMACT.frmMovLavDinero
...
Private Sub cmdsalir_Click()
    Unload Me
End Sub
Private Sub IniciaLavDinero(poLavDinero As SICMACT.frmMovLavDinero)
Dim i As Long
