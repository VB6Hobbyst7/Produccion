VERSION 5.00
Begin VB.Form frmBuscaPersPlanBici 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Busca Persona - Plan Bici"
   ClientHeight    =   2655
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7470
   Icon            =   "frmBuscaPlanBici.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Moveable        =   0   'False
   ...
   End
End
Attribute VB_Name = "frmBuscaPersPlanBici"
...
Set oDatos = New DCapFideicomiso
    ...
    Set rs = oDatos.dGetCuentasPlanBici(fePersonas.TextMatrix(fePersonas.Row, 1))
    
    If Not rs.EOF And Not rs.BOF Then
        Do While Not rs.EOF
            frmCapPlanBici.LstCred.AddItem rs!cCtaCod
            rs.MoveNext
        Loop
    End If
    Set rs = Nothing
...
Dim oDatos As DCapFideicomiso
    ...
    If KeyAscii = 13 Then
        If txtDocPer <> "" Then
            ...
            Set rs = oDatos.dGetDatosPersonaPlan(Trim(txtNomPer))
