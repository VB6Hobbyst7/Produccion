...
Private Function ValidaMonto(ByVal pnMonto As Double) As Boolean
    ValidaMonto = False
    If pnMonto > 100 Then
        MsgBox "El valor ingresado deber ser de [0 - 100]%.", vbInformation, "Aviso"
        ValidaMonto = True
    End If
End Function
...
If (CDbl(edmIngrMN.Text) + CDbl(edmIngrME.Text)) <> 100 Then
    MsgBox "Los Ingresos en MN y ME deben sumar 100%.", vbInformation, "Aviso"
    ValidadIngEgr = True
    Exit Function
End If
If (CDbl(edmEgrMN.Text) + CDbl(edmEgrME.Text)) <> 100 Then
    MsgBox "Los Egresos en MN y ME deben sumar 100%.", vbInformation, "Aviso"
    ValidadIngEgr = True
    Exit Function
End If
End Function
