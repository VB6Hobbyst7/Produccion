VERSION 5.00
Begin VB.Form FrmCFRetirarApr 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Carta Fianza -Retirar de CF Aprobada"
   ClientHeight    =   5640
   ClientLeft      =   2265
   ClientTop       =   1845
   ClientWidth     =   7665
   Icon            =   "FrmCFRetirarApr.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5640
   ...
   End
End
Attribute VB_Name = "FrmCFRetirarApr"
...
'*  ARCHIVO : frmCFRetirarApr
'*  CREACION: 10/09/2002     - LAYG
'*************************************************************************
'*  RESUMEN: RETIRAR CARTA FIANZA que ha sido aprobada
'***************************************************************************
...
Dim lsCta As String
    lsCta = frmCFPersEstado.Inicio(Array(gColocEstAprob, gColocEstAprob), "Retirar Carta Fianza Aprobada", Array(gColCFComercial, gColCFPYME, gColCFTpoProducto))
...
ActXCodCta.Enabled = False
    ...
    Set R = oCF.RecuperaCartaFianzaRetirar(psCodCta)
    Set oCF = Nothing
...
If MsgBox("Desea Grabar Retiro de Carta Fianza Aprobada", vbInformation + vbYesNo, "Sugerencia de Analista") = vbYes Then
    ...
    Set loNCartaFianza = New COMNCartaFianza.NCOMCartaFianza
        Call loNCartaFianza.nCFRetirar(vCodCta, lsFechaHoraGrab, lsComenta, lnRechazo)
        objPista.InsertarPista gsOpeCod, lsMovNro, gsCodPersUser, GetMaquinaUsuario, gInsertar, "Retirar CF Aprobada", vCodCta, gCodigoCuenta
...
Private Sub Form_Load()
    ...
    gsOpeCod = gCredRetirarCFAprobada
End Sub
