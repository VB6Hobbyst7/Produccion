...
Begin VB.Form frmCredFormEvalFormato6 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin SICMACT.EditMoney txtCapacidadNeta2 
         ...
         _extentx        =   2355
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":030A
         text            =   "0"
      End
      Begin SICMACT.EditMoney txtIngresoNeto2 
         ...
         _extentx        =   2355
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":0332
         text            =   "0"
      End
      Begin SICMACT.EditMoney txtExcedenteMensual2 
         ...
         _extentx        =   2355
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":035A
         text            =   "0"
      End
      Begin SICMACT.EditMoney txtRentabilidad 
         ...
         _extentx        =   2355
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":0382
         text            =   "0"
      End
      Begin SICMACT.EditMoney txtLiquidezCte 
         ...
         _extentx        =   2355
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":03AA
         text            =   "0"
      End
   ...
   Begin VB.Frame FrameDatos 
      ...
      Begin SICMACT.EditMoney txtIncrVentasContado 
         ...
         _extentx        =   1455
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":03D2
      ...
      Begin SICMACT.EditMoney txtIncrCompraMercaderia 
         ...
         _extentx        =   1455
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":03FA
         forecolor       =   -2147483640
         text            =   "0"
         enabled         =   -1
      End
      Begin SICMACT.EditMoney txtIncrPagoPersonal 
         ...
         _extentx        =   1455
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":0422
         forecolor       =   -2147483640
         text            =   "0"
         enabled         =   -1
      End
      Begin SICMACT.EditMoney txtIncrGastoVentas 
         ...
         _extentx        =   1455
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":044A
         forecolor       =   -2147483640
         text            =   "0"
         enabled         =   -1
      End
      Begin SICMACT.EditMoney txtIncrConsumo 
         ...
         _extentx        =   1455
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":0472
         forecolor       =   8421504
         text            =   "0"
      End
      Begin VB.Label Label13 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame17 
         ...
         Begin SICMACT.EditMoney txtUltEndeuda 
            ...
            _extentx        =   2355
            _extenty        =   529
            font            =   "frmCredFormEvalFormato6.frx":049A
            text            =   "0"
            enabled         =   -1
         End
         ...
         Begin VB.Label Label11 
            AutoSize        =   -1  'True
            BackStyle       =   0  'Transparent
            Caption         =   "Fecha Ult. endeud. SBS RCC:"
            Height          =   195
            Left            =   11420
            TabIndex        =   70
            Top             =   160
      ...
      Begin SICMACT.EditMoney txtExposicionCredito2 
         ...
         _extentx        =   2355
         _extenty        =   529
         font            =   "frmCredFormEvalFormato6.frx":04C2
         text            =   "0"
      End
   ...
   Begin TabDlg.SSTab SSTabIngresos2 
      ...
      TabPicture(0)   =   "frmCredFormEvalFormato6.frx":04EA
      ...
      TabPicture(1)   =   "frmCredFormEvalFormato6.frx":0506
      ...
      TabPicture(2)   =   "frmCredFormEvalFormato6.frx":0522
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Frame12"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Evaluación"
      TabPicture(3)   =   "frmCredFormEvalFormato6.frx":053E
      Tab(3).ControlEnabled=   -1  'True
      Tab(3).Control(0)=   "Line2"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "Line3"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "frameFlujoEval"
      ...
      TabPicture(4)   =   "frmCredFormEvalFormato6.frx":055A
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "Frame3"
      Tab(4).Control(1)=   "Frame9"
      Tab(4).ControlCount=   2
      TabCaption(5)   =   "Comentarios y Referidos"
      TabPicture(5)   =   "frmCredFormEvalFormato6.frx":0576
      ...
      TabPicture(6)   =   "frmCredFormEvalFormato6.frx":0592
      ...
      Begin VB.Frame frameFlujoHisto 
         ...
         Begin SICMACT.FlexEdit feFlujoCajaHistorico 
            ...
            font            =   "frmCredFormEvalFormato6.frx":05AE
            font            =   "frmCredFormEvalFormato6.frx":05D6
            font            =   "frmCredFormEvalFormato6.frx":05FE
            font            =   "frmCredFormEvalFormato6.frx":0626
            font            =   "frmCredFormEvalFormato6.frx":064E
            fontfixed       =   "frmCredFormEvalFormato6.frx":0676
      ...
      Begin VB.Frame Frame16 
         ...
         Begin SICMACT.FlexEdit feDeclaracionPDT 
            ...
            encabezadosanchos=   "0-1500-0-0-1350-1350-1350-1500-1230"
            font            =   "frmCredFormEvalFormato6.frx":069C
            font            =   "frmCredFormEvalFormato6.frx":06C4
            font            =   "frmCredFormEvalFormato6.frx":06EC
            font            =   "frmCredFormEvalFormato6.frx":0714
            font            =   "frmCredFormEvalFormato6.frx":073C
            fontfixed       =   "frmCredFormEvalFormato6.frx":0764
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            lbultimainstancia=   -1
      ...
      Begin VB.Frame Frame15 
         ...
         Begin SICMACT.FlexEdit feOtrosIngresos 
            ...
            font            =   "frmCredFormEvalFormato6.frx":078A
            font            =   "frmCredFormEvalFormato6.frx":07B2
            font            =   "frmCredFormEvalFormato6.frx":07DA
            font            =   "frmCredFormEvalFormato6.frx":0802
            font            =   "frmCredFormEvalFormato6.frx":082A
            fontfixed       =   "frmCredFormEvalFormato6.frx":0852
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            lbultimainstancia=   -1
      ...
      Begin VB.Frame Frame14 
         ...
         Begin SICMACT.FlexEdit feGastosFamiliares 
            ...
            encabezadosnombres=   "-N-Concepto-Monto-Aux"
            encabezadosanchos=   "0-300-4000-1800-0"
            font            =   "frmCredFormEvalFormato6.frx":0878
            font            =   "frmCredFormEvalFormato6.frx":08A0
            font            =   "frmCredFormEvalFormato6.frx":08C8
            font            =   "frmCredFormEvalFormato6.frx":08F0
            font            =   "frmCredFormEvalFormato6.frx":0918
            fontfixed       =   "frmCredFormEvalFormato6.frx":0940
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            lbultimainstancia=   -1
      ...
      Begin VB.Frame frameFlujoEval 
         ...
         Begin SICMACT.FlexEdit feFlujoCajaMensual 
            ...
            allowuserresizing=   3
            encabezadosnombres=   "-Concepto-Monto-nConsCod-nConsValor"
            encabezadosanchos=   "300-3500-1700-0-0"
            font            =   "frmCredFormEvalFormato6.frx":0966
            font            =   "frmCredFormEvalFormato6.frx":098E
            font            =   "frmCredFormEvalFormato6.frx":09B6
            font            =   "frmCredFormEvalFormato6.frx":09DE
            font            =   "frmCredFormEvalFormato6.frx":0A06
            fontfixed       =   "frmCredFormEvalFormato6.frx":0A2E
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            lbultimainstancia=   -1
      ...
      Begin VB.Frame Frame11 
         ...
         Begin SICMACT.FlexEdit feReferidos 
            ...
            font            =   "frmCredFormEvalFormato6.frx":0A54
            font            =   "frmCredFormEvalFormato6.frx":0A7C
            font            =   "frmCredFormEvalFormato6.frx":0AA4
            font            =   "frmCredFormEvalFormato6.frx":0ACC
            font            =   "frmCredFormEvalFormato6.frx":0AF4
            fontfixed       =   "frmCredFormEvalFormato6.frx":0B1C
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            lbultimainstancia=   -1
      ...
      Begin VB.Frame Frame12 
         ...
         Begin SICMACT.FlexEdit feCoeFinan 
            ...
            font            =   "frmCredFormEvalFormato6.frx":0B42
            font            =   "frmCredFormEvalFormato6.frx":0B6A
            font            =   "frmCredFormEvalFormato6.frx":0B92
            font            =   "frmCredFormEvalFormato6.frx":0BBA
            font            =   "frmCredFormEvalFormato6.frx":0BE2
            fontfixed       =   "frmCredFormEvalFormato6.frx":0C0A
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            lbultimainstancia=   -1
      ...
      Begin VB.Frame Frame6 
         ...
         Begin SICMACT.FlexEdit feEstaGananPerd 
            ...
            encabezadosnombres=   "-Concepto-Monto-nConsCod-nConsValor"
            encabezadosanchos=   "300-4500-1700-0-0"
            font            =   "frmCredFormEvalFormato6.frx":0C30
            font            =   "frmCredFormEvalFormato6.frx":0C58
            font            =   "frmCredFormEvalFormato6.frx":0C80
            font            =   "frmCredFormEvalFormato6.frx":0CA8
            font            =   "frmCredFormEvalFormato6.frx":0CD0
            fontfixed       =   "frmCredFormEvalFormato6.frx":0CF8
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            lbultimainstancia=   -1
      ...
      Begin VB.Frame Frame8 
         ...
         Begin SICMACT.FlexEdit FlexEdit1 
            ...
            font            =   "frmCredFormEvalFormato6.frx":0D1E
            font            =   "frmCredFormEvalFormato6.frx":0D46
            font            =   "frmCredFormEvalFormato6.frx":0D6E
            font            =   "frmCredFormEvalFormato6.frx":0D96
            font            =   "frmCredFormEvalFormato6.frx":0DBE
            fontfixed       =   "frmCredFormEvalFormato6.frx":0DE6
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            lbultimainstancia=   -1
      ...
      Begin SICMACT.FlexEdit feActivos 
         ...
         font            =   "frmCredFormEvalFormato6.frx":0E0C
         font            =   "frmCredFormEvalFormato6.frx":0E34
         font            =   "frmCredFormEvalFormato6.frx":0E5C
         font            =   "frmCredFormEvalFormato6.frx":0E84
         font            =   "frmCredFormEvalFormato6.frx":0EAC
         fontfixed       =   "frmCredFormEvalFormato6.frx":0ED4
         backcolorcontrol=   -2147483643
         backcolorcontrol=   -2147483643
         backcolorcontrol=   -2147483643
         lbultimainstancia=   -1
      ...
      Begin SICMACT.FlexEdit fePasivos 
         ...
         font            =   "frmCredFormEvalFormato6.frx":0EFA
         font            =   "frmCredFormEvalFormato6.frx":0F22
         font            =   "frmCredFormEvalFormato6.frx":0F4A
         font            =   "frmCredFormEvalFormato6.frx":0F72
         font            =   "frmCredFormEvalFormato6.frx":0F9A
         fontfixed       =   "frmCredFormEvalFormato6.frx":0FC2
         backcolorcontrol=   -2147483643
         backcolorcontrol=   -2147483643
         backcolorcontrol=   -2147483643
         lbultimainstancia=   -1
...
'    If KeyAscii = 13 Then
        ...
        'CboFecRegEEFF.ListIndex = IndiceListaCombo(CboFecRegEEFF, rsSuger!nSTipoProdCod)
        If fbImprimirVB Then
            CboFecRegEEFF.ListIndex = 0
        End If
...
'    End If
    ...
    'If CCur(Me.feFlujoCajaMensual.TextMatrix(22, 2)) = 0 Then 'saldo disponible de flujo de caja 'CTI320200110 ERS003-2020. Comentó
    If CCur(Me.feFlujoCajaMensual.TextMatrix(23, 2)) = 0 Then 'saldo disponible de flujo de caja 'CTI320200110 ERS003-2020. Agregó
    ...
    If Not ValidaIfiExisteCompraDeuda(fsCtaCod, MatIfiGastoFami, MatIfiGastoNego, lsMensajeIfi, MatIfiNoSupervisadaGastoFami, MatIfiNoSupervisadaGastoNego) Or Len(Trim(lsMensajeIfi)) > 0 Then
...
'------------------ IFIS NO SUPERVISADAS FLUJO DE CAJA
    'Cuotas IFIs ->FLUJO DE CAJA
    If IsArray(MatIfiNoSupervisadaGastoNego) Then 'Pregunto Matriz no Sea Vacia
        If UBound(MatIfiNoSupervisadaGastoNego) > 0 Then
        Call oDCred.EliminaCredFormEvalGrillaOtrasIfis(fsCtaCod, lnNumForm, gFormatoGastosNegoFlujoCaja, gCodCuotaIfiNoSupervisadaFlujoCaja)
            For i = 0 To UBound(MatIfiNoSupervisadaGastoNego) - 1
                Call oDCred.InsertaCredFormEvalCuotaIFI(fsCtaCod, lnNumForm, gFormatoGastosNegoFlujoCaja, gCodCuotaIfiNoSupervisadaFlujoCaja, MatIfiNoSupervisadaGastoNego(i, 0), MatIfiNoSupervisadaGastoNego(i, 1), CDbl(MatIfiNoSupervisadaGastoNego(i, 2)))
            Next i
        End If
    End If
'Fin CTI320200110
...
'----------------------------------IFIS GASTOS FAMILIARES
    ...
    If IsArray(MatIfiGastoFami) Then 'Pregunto Matriz no Sea Vacia
        ...
        Call oDCred.EliminaCredFormEvalGrillaOtrasIfis(fsCtaCod, lnNumForm, gFormatoGastosFami, gCodCuotaIfiGastoFami)
...
'CTI320200110 ERS003-2020
'----------------------------------IFIS NO SUPERVISADAS GASTOS FAMILIARES
    'Cuotas IFIs ->GastosFamiliar
    If IsArray(MatIfiNoSupervisadaGastoFami) Then 'Pregunto Matriz no Sea Vacia
        If UBound(MatIfiNoSupervisadaGastoFami) > 0 Then
        Call oDCred.EliminaCredFormEvalGrillaOtrasIfis(fsCtaCod, lnNumForm, gFormatoGastosFami, gCodCuotaIfiNoSupervisadaGastoFami)
            For i = 0 To UBound(MatIfiNoSupervisadaGastoFami) - 1
                Call oDCred.InsertaCredFormEvalCuotaIFI(fsCtaCod, lnNumForm, gFormatoGastosFami, gCodCuotaIfiNoSupervisadaGastoFami, MatIfiNoSupervisadaGastoFami(i, 0), MatIfiNoSupervisadaGastoFami(i, 1), CDbl(MatIfiNoSupervisadaGastoFami(i, 2)))
            Next i
        End If
    End If
'Fin CTI320200110
...
'    objFCBS_UP.FondoCrecerBitacora IIf(fnTipoRegMant = 1, gCredRegistrarEvaluacionCred, gCredMantenimientoEvaluacionCred), lcMovNro, gsCodPersUser, fsCtaCod, "Formato de Evaluación (Sicmac Negocio)"
...
Private Sub cmdImpEEFF_Click()
    ...
    Set rsDatIfiGastoFami = oDCOMFormatosEval.RecuperaDatosIfiCuota(fsCtaCod, lnNumForm, gFormatoGastosFami, gCodCuotaIfiGastoFami)
...
'            Me.fePasivos.TextMatrix(18, 3) = Format(CDbl(Me.fePasivos.TextMatrix(16, 3)) + CDbl(Me.fePasivos.TextMatrix(17, 3)), "#,#0.00")
    ...
    If pnActPas = 5 Then '--flujo de caja
        ...
        'saldo disponible
        'Me.feFlujoCajaMensual.TextMatrix(22, 2) = Format(CCur(Me.feFlujoCajaMensual.TextMatrix(5, 2)) - (CCur(Me.feFlujoCajaMensual.TextMatrix(6, 2)) - CCur(Me.feFlujoCajaMensual.TextMatrix(18, 2)) - CCur(Me.feFlujoCajaMensual.TextMatrix(19, 2))), "#,#0.00") 'CTI320200110 ERS003-2020. Comentó
        Me.feFlujoCajaMensual.TextMatrix(23, 2) = Format(CCur(Me.feFlujoCajaMensual.TextMatrix(5, 2)) - (CCur(Me.feFlujoCajaMensual.TextMatrix(6, 2)) - CCur(Me.feFlujoCajaMensual.TextMatrix(18, 2)) - CCur(Me.feFlujoCajaMensual.TextMatrix(19, 2))), "#,#0.00") 'CTI320200110 ERS003-2020. Agregó
    End If
    If pnActPas = 6 Then '-- flujo de caja Historico 'LUCV20171015, Agregó según ERS0512017
        ...
        'saldo disponible
        'Me.feFlujoCajaHistorico.TextMatrix(22, 2) = Format(CCur(Me.feFlujoCajaHistorico.TextMatrix(5, 2)) - (CCur(Me.feFlujoCajaHistorico.TextMatrix(6, 2)) - CCur(Me.feFlujoCajaHistorico.TextMatrix(18, 2)) - CCur(Me.feFlujoCajaHistorico.TextMatrix(19, 2))), "#,#0.00")'CTI320200110 ERS003-2020. Comentó
        Me.feFlujoCajaHistorico.TextMatrix(23, 2) = Format(CCur(Me.feFlujoCajaHistorico.TextMatrix(5, 2)) - (CCur(Me.feFlujoCajaHistorico.TextMatrix(6, 2)) - CCur(Me.feFlujoCajaHistorico.TextMatrix(18, 2)) - CCur(Me.feFlujoCajaHistorico.TextMatrix(19, 2))), "#,#0.00") 'CTI320200110 ERS003-2020. Agregó
    End If
End Sub
...
Private Sub feFlujoCajaMensual_EnterCell()
    ...
    Select Case CInt(feFlujoCajaMensual.TextMatrix(Me.feFlujoCajaMensual.row, 0)) 'celda que  o se puede editar
        'Case 5, 6, 18, 22 'CTI320200110 ERS003-2020. Comentó
        Case 5, 6, 18, 23  'CTI320200110 ERS003-2020. Agregó
...
Private Sub feFlujoCajaMensual_OnClickTxtBuscar(psCodigo As String, psDescripcion As String)
    ...
    If feFlujoCajaMensual.TextMatrix(feFlujoCajaMensual.row, 4) = gCodCuotaIfiFlujoCaja Then 'CTI320200110 ERS003-2020. Agregó
        If psCodigo = 0 Then
            fnTotalRefFlujoCaja = 0
            Set MatIfiGastoNego = Nothing
            frmCredFormEvalCuotasIfis.Inicio (CCur(feFlujoCajaMensual.TextMatrix(feFlujoCajaMensual.row, 2))), fnTotalRefFlujoCaja, MatIfiGastoNego, feFlujoCajaMensual.TextMatrix(feFlujoCajaMensual.row, 1), gFormatoGastosNegoFlujoCaja, gCodCuotaIfiFlujoCaja
    ...
    Else
        If psCodigo = 0 Then
            ...
            frmCredFormEvalCuotasIfis.Inicio (CCur(feFlujoCajaMensual.TextMatrix(feFlujoCajaMensual.row, 2))), fnTotalRefFlujoCaja, MatIfiNoSupervisadaGastoNego, _
                                        feFlujoCajaMensual.TextMatrix(feFlujoCajaMensual.row, 1), gFormatoGastosNegoFlujoCaja, gCodCuotaIfiNoSupervisadaFlujoCaja 'CTI320200110 ERS003-2020. Agregó
            psCodigo = Format(fnTotalRefFlujoCaja, "#,##0.00")
        Else
            frmCredFormEvalCuotasIfis.Inicio (CCur(feFlujoCajaMensual.TextMatrix(feFlujoCajaMensual.row, 2))), fnTotalRefFlujoCaja, MatIfiNoSupervisadaGastoNego, _
                                        feFlujoCajaMensual.TextMatrix(feFlujoCajaMensual.row, 1), gFormatoGastosNegoFlujoCaja, gCodCuotaIfiNoSupervisadaFlujoCaja 'CTI320200110 ERS003-2020. Agregó
...
'-------------------------------- LLENAR flujo de caja
    ...
    'Set rsDatIfiflujocaja = oDCOMFormatosEval.RecuperaDatosIfiCuota(psCtaCod, pnFormato, 7027)'CTI320200110 ERS003-2020. Comentó
    Set rsDatIfiflujocaja = oDCOMFormatosEval.RecuperaDatosIfiCuota(psCtaCod, pnFormato, gFormatoGastosNegoFlujoCaja, gCodCuotaIfiFlujoCaja) 'CTI320200110 ERS003-2020. Agregó
    Set rsDatIfiNoSupervisadaGastoNego = oDCOMFormatosEval.RecuperaDatosIfiCuota(psCtaCod, pnFormato, gFormatoGastosNegoFlujoCaja, gCodCuotaIfiNoSupervisadaFlujoCaja) 'CTI320200110 ERS003-2020. Agregó
    
    If rsDatFlujoCaja.RecordCount <> 0 Then
        Me.feFlujoCajaMensual.Clear
        feFlujoCajaMensual.FormaCabecera
        feFlujoCajaMensual.rows = 2
        If Not (rsDatIfiflujocaja.BOF Or rsDatIfiflujocaja.EOF) Then
            For i = 1 To rsDatIfiflujocaja.RecordCount
               pnMontoOtrasIfisEmpresarial = pnMontoOtrasIfisEmpresarial + rsDatIfiflujocaja!nMonto
        ...
        nFila = 0
            Do While Not (rsDatFlujoCaja.EOF)
                ...
                If fbImprimirVB And rsDatFlujoCaja!nConsValor = 19 Then
                    feFlujoCajaMensual.TextMatrix(lnFila, 2) = Format(pnMontoOtrasIfisEmpresarial, "#,##0.00")
                End If
            ...
            If Not (rsDatIfiNoSupervisadaGastoNego.BOF And rsDatIfiNoSupervisadaGastoNego.EOF) Then
                '--- IFIS NO SUPERVISADAS DE FLUJO DE CAJA
                ReDim MatIfiNoSupervisadaGastoNego(rsDatIfiNoSupervisadaGastoNego.RecordCount, 4)
                i = 0
                rsDatIfiNoSupervisadaGastoNego.MoveFirst
        ...
        rsDatIfiNoSupervisadaGastoNego.Close 'CTI320200110 ERS003-2020. Agregó
        Set rsDatIfiNoSupervisadaGastoNego = Nothing 'CTI320200110 ERS003-2020. Agregó
    ...
    Set rsDatIfiflujocajaHistorico = oDCOMFormatosEval.RecuperaDatosIfiCuota(psCtaCod, pnFormato, gFormatoGastosNegoFlujoCaja, gCodCuotaIfiFlujoCaja, 1)
        ...
        nFila = 0
            Do While Not (rsDatFlujoCajaHistorico.EOF)
                ...
                Select Case CInt(feFlujoCajaHistorico.TextMatrix(feFlujoCajaHistorico.row, 0))
                    ...
                    'Case 5, 6, 22 'CTI320200110 ERS003-2020. Comentó
                    Case 5, 6, 23 'CTI320200110 ERS003-2020. Agregó
                    ...
                    Case gCodCuotaIfiNoSupervisadaFlujoCaja 'Agrego JOEP20171015 Segun ERS051-2017 Flujo de Caja 'CTI320200110 ERS003-2020. Agregó: gCodCuotaIfiNoSupervisadaFlujoCaja
                        Me.feFlujoCajaHistorico.RowHeight(lnFila) = 1
                End Select
...
'            Loop
    ...
    '------------------------------------------------- LLENAR gastos familiares
        ...
        Set rsDatIfiGastoFami = oDCOMFormatosEval.RecuperaDatosIfiCuota(psCtaCod, pnFormato, gFormatoGastosFami, gCodCuotaIfiGastoFami)
        Set rsDatIfiNoSupervisadaGastoFami = oDCOMFormatosEval.RecuperaDatosIfiCuota(psCtaCod, pnFormato, gFormatoGastosFami, gCodCuotaIfiNoSupervisadaGastoFami) 'CTI320200110 ERS003-2020. Agregó
        ...
        If rsDatGastoFam.RecordCount > 0 Then
            ...
            'CTI320200110 ERS003-2020. Agregó
            If Not (rsDatIfiNoSupervisadaGastoFami.EOF And rsDatIfiNoSupervisadaGastoFami.BOF) Then
                '--- IFIS NO SUPERVISADAS DE GASTOS FAMILIARES
                ReDim MatIfiNoSupervisadaGastoFami(rsDatIfiNoSupervisadaGastoFami.RecordCount, 4)
                j = 0
                rsDatIfiNoSupervisadaGastoFami.MoveFirst
    ...
    Set rsDatIfiGastoFami = Nothing
    rsDatIfiNoSupervisadaGastoFami.Close 'CTI320200110 ERS003-2020. Agregó
    Set rsDatIfiNoSupervisadaGastoFami = Nothing 'CTI320200110 ERS003-2020. Agregó
...
'------------------------------------------------- LLENAR declara PDT
    ...
    Set rsDatRef = oDCOMFormatosEval.RecuperaDatosReferidos(psCtaCod)
        ...
        Dim nMontoGastoFamiliar As Currency
        Dim nMontoGastonNegocio As Currency
        Set rsDCredito = oDCOMFormatosEval.RecuperaSolicitudDatoBasicosEval(fsCtaCod)
        Set rsDatIfiGastoFami = oDCOMFormatosEval.RecuperaDatosIfiCuota(fsCtaCod, lnNumForm, gFormatoGastosFami, gCodCuotaIfiGastoFami)
        Set rsDatIfiflujocaja = oDCOMFormatosEval.RecuperaDatosIfiCuota(fsCtaCod, lnNumForm, gFormatoGastosNegoFlujoCaja, gCodCuotaIfiFlujoCaja)

        If CInt(rsDCredito!nTmpoLocalAnio) = 0 Then
                ...
                Do While Not rsDatIfiflujocaja.EOF
                    ...
                    MatIfiGastoNego(i, 1) = rsDatIfiflujocaja!CDescripcion
                    MatIfiGastoNego(i, 2) = Format(IIf(IsNull(rsDatIfiflujocaja!nMonto), 0, rsDatIfiflujocaja!nMonto), "#0.00")
                    nMontoGastonNegocio = nMontoGastonNegocio + IIf(IsNull(rsDatIfiflujocaja!nMonto), 0, rsDatIfiflujocaja!nMonto)
                    rsDatIfiflujocaja.MoveNext
                    i = i + 1
                Loop
                rsDatIfiflujocaja.Close
                ...
                Do While Not rsDatIfiGastoFami.EOF
                    ...
                    MatIfiGastoFami(j, 1) = rsDatIfiGastoFami!CDescripcion
                    MatIfiGastoFami(j, 2) = Format(IIf(IsNull(rsDatIfiGastoFami!nMonto), 0, rsDatIfiGastoFami!nMonto), "#0.00")
                    nMontoGastoFamiliar = nMontoGastoFamiliar + IIf(IsNull(rsDatIfiGastoFami!nMonto), 0, rsDatIfiGastoFami!nMonto)
                      
                    rsDatIfiGastoFami.MoveNext
                j = j + 1
                Loop
                feGastosFamiliares.TextMatrix(5, 3) = Format(nMontoGastoFamiliar, "#0.00")
                feFlujoCajaMensual.TextMatrix(19, 2) = Format(nMontoGastonNegocio, "#0.00")
                rsDatIfiGastoFami.Close
                Set rsDatIfiGastoFami = Nothing
        End If
        '***************************************************************
...
Public Function Inicio(ByVal psTipoRegMant As Integer, ByVal psCtaCod As String, ByVal pnFormato As Integer, ByVal pnProducto As Integer, _
                    ByVal pnSubProducto As Integer, ByVal pnMontoExpCred As Double, ByVal pbImprimir As Boolean, _
...
ValidaDatos = False
    ...
    If txtFechaVisita.Text = "__/__/____" And lnColocCondi <> 4 Then 'Agrego JOEP20190220 CP And lnColocCondi <> 4
        MsgBox "Ingrese la fecha de visita en la propuesta del Crédito", vbOKOnly, "Atención"
        Exit Function
    End If
    If txtEntornoFamiliar2.Text = "" And lnColocCondi <> 4 Then 'Agrego JOEP20190220 CP And lnColocCondi <> 4
        MsgBox "Ingrese el entorno familiar en la propuesta del Crédito", vbOKOnly, "Atención"
        Exit Function
    End If
    If txtGiroUbicacion2.Text = "" And lnColocCondi <> 4 Then 'Agrego JOEP20190220 CP And lnColocCondi <> 4
        MsgBox "Ingrese la ubicación del Giro en la propuesta del Crédito", vbOKOnly, "Atención"
        Exit Function
    End If
    If txtExperiencia2.Text = "" And lnColocCondi <> 4 Then 'Agrego JOEP20190220 CP And lnColocCondi <> 4
        MsgBox "Ingrese la experiencia en la propuesta del Crédito", vbOKOnly, "Atención"
        Exit Function
    End If
    If txtFormalidadNegocio2.Text = "" And lnColocCondi <> 4 Then 'Agrego JOEP20190220 CP And lnColocCondi <> 4
        MsgBox "Ingrese la formalidad del negocio en la propuesta del Crédito", vbOKOnly, "Atención"
        Exit Function
    End If
    If txtColaterales2.Text = "" And lnColocCondi <> 4 Then 'Agrego JOEP20190220 CP And lnColocCondi <> 4
        MsgBox "Ingrese los colaterales y garantías en la propuesta del Crédito", vbOKOnly, "Atención"
        Exit Function
    End If
    If txtDestino2.Text = "" And lnColocCondi <> 4 Then 'Agrego JOEP20190220 CP And lnColocCondi <> 4
...
'        SSTabIngresos.TabVisible(0) = False
'    End If
'    'Fin CTI320200110
...
'    lcFecRegEF = ""
    CboFecRegEEFF.Enabled = False 'CTI3-ERS0032020
    CboFecRegEEFF.Clear
        
        Do While Not rs.EOF
            CboFecRegEEFF.Enabled = True 'CTI3-ERS0032020
...
Private Sub feFlujoCajaHistorico_EnterCell()
    ...
    Select Case CInt(feFlujoCajaHistorico.TextMatrix(Me.feFlujoCajaHistorico.row, 0)) 'celda que  o se puede editar
        'Case 1, 4, 5, 6, 22 'CTI320200110 ERS003-2020. Comentó
        Case 1, 4, 5, 6, 23 'CTI320200110 ERS003-2020. Agregó
