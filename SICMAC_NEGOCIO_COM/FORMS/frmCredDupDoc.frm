...
'****************************************************************
                ...
                'psRiesgo = "Riesgo 2" 'Comentado por JOEP 20170420
                    ...
                    For i = 1 To prsCredGarant.RecordCount
                        ...
                        'INICIO Agrego JOEP 20170420
                            If prsCredGarant!nTratLegal = 1 Or prsCredGarant!nTpoBienContrato = gTpoBienFuturo Then
                                psRiesgo = "Riesgo 2"
                                nValorR2 = nValorR2 + 1
                            Else
                                psRiesgo = "Riesgo 1"
    ...
    'SECCION Nº 6
        ...
        If Not (Left(pR!cTpoProdCod, 1) = "8" Or Left(pR!cTpoProdCod, 1) = "7") Then
        ...
        If (pDRRatiosF!nLiquidezCte > 0) And (Left(pR!cTpoCredCod, 1) <> "8") Then 'CTI320200110 ERS003-2020. Agregó Condicional
            oDoc.WTextBox nPosicion + 12, 57, 12, 63, "Liquidez", "F1", 5, hLeft, , , , , , 2
        ...
        If (pDRRatiosF!nPatrimonio > 0) And (Left(pR!cTpoCredCod, 1) <> "8") Then 'CTI320200110 ERS003-2020. Agregó Condicional
        ...
        If (pDRRatiosF!nEndeuPat > 0) And (Left(pR!cTpoCredCod, 1) <> "8") Then 'CTI320200110 ERS003-2020. Agregó Condicional
        ...
        If (pDRRatiosF!nRentaPatri > 0) And (Left(pR!cTpoCredCod, 1) <> "8") Then 'CTI320200110 ERS003-2020. Agregó Condicional
...
'CTI3 END
    'RECO NUEVO
    nPosicion = nPosicion + 70 'CTI3 ERS0032020
...
Else
    ...
    Set oDpExposicion = New COMDCredito.DCOMCredito
    'JAOR20211004 ADD: pR!Nro_Credito
    Dim cNroCredito As String
    cNroCredito = pR!Nro_Credito
    Set expo = oDpExposicion.RecuperaAutoporExpo(nRunico, pR!cDestino, pR!Modalidad, lnMontoRiesgoUnico, pR!Oficina, sPdirecto, nClePref, , cNroCredito)
    Set oDpExposicion = Nothing
