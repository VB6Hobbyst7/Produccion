VERSION 5.00
Begin VB.Form frmCredRiesgoLimiteZonaGeogAutoriza 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Solicitud fuera de Limite por Zona Geografica"
   ClientHeight    =   5685
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10545
   Icon            =   "frmCredRiesgoLimiteZonaGeogAutoriza.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5685
   ...
   Begin VB.ComboBox cmbAgencia 
      Height          =   315
      ItemData        =   "frmCredRiesgoLimiteZonaGeogAutoriza.frx":030A
      Left            =   840
      List            =   "frmCredRiesgoLimiteZonaGeogAutoriza.frx":030C
   ...
   Begin SICMACT.FlexEdit feCredInfRiesgo 
      ...
      AllowUserResizing=   3
      RowSizingMode   =   1
      EncabezadosNombres=   "#-Agencia-Crédito-Titular-Tipo Producto-Moneda-Monto-Monto MN-Zona Geografica MN-Limite-% con este Credito-Zona Geo.-nCodAge"
   ...
   End
End
Attribute VB_Name = "frmCredRiesgoLimiteZonaGeogAutoriza"
...
If feCredInfRiesgo.TextMatrix(1, 2) <> "" Then
        ...
        Call oDPersGen.ActualizarSolicitudAutorizacionZonaGeog(feCredInfRiesgo.TextMatrix(feCredInfRiesgo.row, 2), Trim(Me.txtGlosa.Text), pnEstado)
Else
...
Dim objAgZ As COMDConstantes.DCOMAgencias
Set objAgZ = New COMDConstantes.DCOMAgencias

Set oDPersGen = New COMDCredito.DCOMCredito
Set rs = oDPersGen.RecuperaSolicitudZonaGeog
...
If nValorInicio = 0 Then
    Set rsCombo = objAgZ.ObtieneAgencias
