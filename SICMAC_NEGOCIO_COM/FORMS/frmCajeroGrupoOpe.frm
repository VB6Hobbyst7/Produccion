   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame fraDatosGen 
         ...
         Begin SICMACT.TxtBuscar txtBuscarTipo 
            ...
            appearance      =   1
            appearance      =   1
            font            =   "frmCajeroGrupoOpe.frx":0342
            appearance      =   1
            stitulo         =   ""
         End
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton cmdElimina 
            Height          =   465
            Left            =   4185
            Picture         =   "frmCajeroGrupoOpe.frx":036E
            Style           =   1  'Graphical
            TabIndex        =   16
            Top             =   2625
            Width           =   540
         ...
         Begin VB.CommandButton cmdAgregar 
            Height          =   465
            Left            =   4170
            Picture         =   "frmCajeroGrupoOpe.frx":0FB0
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   2055
            Width           =   540
         ...
         Begin SICMACT.FlexEdit fgOpeAsig 
            ...
            font            =   "frmCajeroGrupoOpe.frx":1BF2
            font            =   "frmCajeroGrupoOpe.frx":1C1A
            font            =   "frmCajeroGrupoOpe.frx":1C42
            font            =   "frmCajeroGrupoOpe.frx":1C6A
            font            =   "frmCajeroGrupoOpe.frx":1C92
            fontfixed       =   "frmCajeroGrupoOpe.frx":1CBA
         ...
         Begin SICMACT.FlexEdit fgOpeNoAsig 
            ...
            encabezadosnombres=   "N°-Codigo-Descripción"
            encabezadosanchos=   "350-800-2500"
            font            =   "frmCajeroGrupoOpe.frx":1CE0
            font            =   "frmCajeroGrupoOpe.frx":1D08
            font            =   "frmCajeroGrupoOpe.frx":1D30
            font            =   "frmCajeroGrupoOpe.frx":1D58
            font            =   "frmCajeroGrupoOpe.frx":1D80
            fontfixed       =   "frmCajeroGrupoOpe.frx":1DA8
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            backcolorcontrol=   -2147483643
            lbultimainstancia=   -1
...
Dim oGrupo As COMDConstSistema.DCOMOperacion
...
If oGrupo.VerificaGruposOpe(txtCodGrupo.Text, fgOpeNoAsig.TextMatrix(fgOpeNoAsig.Row, 1)) Then
    MsgBox "Operación ya se encuentra registrada en grupo seleccionado", vbInformation, "Aviso"
    Exit Sub
End If
oGrupo.InsertaGruposOpe fgOpeNoAsig.TextMatrix(fgOpeNoAsig.Row, 1), txtCodGrupo.Text
'fgOpeNoAsig.EliminaFila fgOpeNoAsig.Row
Set fgOpeAsig.Recordset = oGrupo.GetOpeGrupo(txtCodGrupo.Text)
End Sub
...
oGrupo.DeleteGruposOpe fgOpeAsig.TextMatrix(fgOpeAsig.Row, 1), txtCodGrupo.Text
...
If fgOpeAsig.TextMatrix(1, 0) <> "" Then
    ...
    Exit Sub
End If
If Len(Trim(txtCodGrupo.Text)) = 0 Then
...
If MsgBox("Desea Eliminar el Grupo seleccionado??", vbYesNo + vbInformation, "Aviso") = vbYes Then
    oGrupo.DeleteOpeGrupo Trim(txtCodGrupo.Text)
    CargaDatos
End If
End Sub
...
If MsgBox("Desea Grabar Grupo??", vbYesNo + vbQuestion, "Aviso") = vbYes Then
    lsOpeCod = txtCodGrupo.Text
    If lbNuevo Then
        oGrupo.InsertaOpeGrupo txtCodGrupo.Text, txtNombre.Text, Val(spnOrden.Valor), _
         IIf(chkIngreso.value = 1, "I", "E"), chkEfectivo.value, txtBuscarTipo.Text, IIf(chkSuma.value = 1, "S", "N")
    Else
        oGrupo.ActOpeGrupo txtCodGrupo.Text, txtNombre.Text, spnOrden.Valor, _
         IIf(chkIngreso.value = 1, "I", "E"), chkEfectivo.value, txtBuscarTipo.Text, IIf(chkSuma.value = 1, "S", "N")
    End If
...
If Val(spnOrden.Valor) = 0 Then
    ...
    Exit Function
End If
If Len(Trim(txtBuscarTipo.Text)) = 0 Then
...
Private Sub Form_Load()
    ...
    Set oGrupo = New COMDConstSistema.DCOMOperacion
...
lblTipoDesc.Caption = txtBuscarTipo.psDescripcion
End Sub
