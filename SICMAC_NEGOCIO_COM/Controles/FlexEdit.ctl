...
'   On Error GoTo EnfocaTextoErr
   ...
   If txtCelda.Name <> "txtFecha" And txtCelda.Name <> "cboCelda" Then
...
End Property
Public Function GetRsNew() As ADODB.Recordset
Dim i As Long
Dim j As Long
...
If FlxGd.TextMatrix(1, 0) <> "" Then
    ...
    For i = 1 To FlxGd.Cols - 1
        ...
        Else
            If IsNumeric(FlxGd.TextMatrix(lnFila + 1, i)) And FlxGd.ColAlignment(i) >= 7 Then
                lsTipoDato = adDouble
            Else
        ...
        If lsTipoDato = adVarChar Then
            rsAux.Fields.Append FlxGd.TextMatrix(lnFila, i), lsTipoDato, Val(adVarChar), adFldMayBeNull
        Else
