...
Public codigoOpcionMenu As String 'PTI1 20170626
...
'BEGIN PTI120170530 según ERS014-2017
'ULTIMO CAMBIO
    If codigoOpcionMenu <> "" Then
        pCodOpe = codigoOpcionMenu
    End If
...
If Not UP Is Nothing Then
    ...
    If val(UP.sPersPersoneria) = gPersonaNat Then
      ...
      ' m_sPersNroDoc = UP.sPersIdnroDNI & "" Modicado By JACA 20110930
      
      'JACA 20110930*******************************
      If UP.sPersIdnroDNI <> "" Then
            m_sPersNroDoc = UP.sPersIdnroDNI & ""
      ElseIf UP.sPersIdnroOtro <> "" Then
            m_sPersNroDoc = UP.sPersIdnroOtro & ""
      End If
      'JACA END************************************
...
If Not rs.EOF And Not rs.BOF Then
    ...
    If Not IsNull(rs!cActiGiro1) Then 'JACA 20110303
        If rs!cActiGiro1 <> "" Then 'JACA 20110428
