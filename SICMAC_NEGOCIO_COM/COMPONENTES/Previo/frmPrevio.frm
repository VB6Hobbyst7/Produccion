...
Dim o As New COMFunciones.FCOMVarImpresion
...
Private Function GetCadenaFormateada(psCadena As String, pImpresora As Impresoras) As String
    Dim lsCad As String
    Dim oFunImpre As New COMFunciones.FCOMVarImpresion
    lsCad = psCadena
    
    If pImpresora = oFunImpre.gImpDfecto Then
