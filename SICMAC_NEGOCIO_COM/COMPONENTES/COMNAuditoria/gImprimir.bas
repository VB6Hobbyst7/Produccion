...
' Definición de Cabecera 1
  ...
  If psMovNro <> "" And lOpe Then
     sImpre = sImpre & CON & BON & ImpreFormat(psEmpresaLogo, 55) & COFF & " " & PrnSet("I+") & "Operación: " & psOpeCod & " # " & psMovNro & PrnSet("I-") & BOFF & oImpresora.gPrnSaltoLinea
...
Public Function Cabecera(sTit As String, P As Integer, psSimbolo As String, pnColPage As Integer, Optional sCabe As String = "", Optional sFecha As String = "", Optional psEmprLogo As String = " CMAC - MAYNAS ") As String
...
End If
   ...
   P = P + 1
   Cabecera = Cabecera + ImpreFormat(psEmprLogo, 57) & sFecha & "-" & Format(Time, "hh:mm:ss") & oImpresora.gPrnSaltoLinea
   Cabecera = Cabecera + "  RUC: " + gsRUC + Space(50) & "Pag. " & Format(P, "000") & oImpresora.gPrnSaltoLinea
   Cabecera = Cabecera & oImpresora.gPrnNegritaON & Centra(sTit, pnColPage) & oImpresora.gPrnNegritaOFF & oImpresora.gPrnSaltoLinea
   If psSimbolo <> "" Then
      Cabecera = Cabecera & oImpresora.gPrnNegritaON & Centra(" M O N E D A   " & IIf(psSimbolo = gcMN, "N A C I O N A L ", "E X T R A N J E R A "), pnColPage) & oImpresora.gPrnNegritaOFF & oImpresora.gPrnSaltoLinea
   End If
   If sCabe <> "" Then
...
Public Function CabeceraCusco(sTit As String, P As Integer, psSimbolo As String, pnColPage As Integer, Optional sCabe As String = "", Optional sFecha As String = "", Optional psEmprLogo As String = " CMAC - CUSCO ") As String
Dim BON As String
Dim BOFF As String
Dim CON As String
Dim COFF As String
