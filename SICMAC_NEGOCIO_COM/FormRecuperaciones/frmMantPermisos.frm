...
Dim NumMenus As Integer
    ...
    If MsgBox("Esta Seguro que Desea Regenerar el Menu", vbInformation + vbYesNo, "Aviso") = vbYes Then
        ...
        'Call oAcceso.RegeneraMenu(MatMenu, 0) 'marg20181217 comento
        Call oAcceso.RegeneraMenu(MatMenu, 6) 'marg20181217 agrego
...
Private Sub cmdsalir_Click()
    'Call oAcceso.CargaMenu(gsDominio, gsCodUser, , , , 0) 'marg20181217 comento
    Call oAcceso.CargaMenu(gsDominio, gsCodUser, , , , 6) 'marg20181217 agrego
...
'********************************************************************************
'Call oAcceso.CargaControles(gsDominio, MatUser, MatGrupo, RsMenu, rsOpe, gsCodUser, rsOpcEsp, rsCargos, 0) 'AMDO 20130726, Se agrego RsOpcEsp,RsCargos 'marg20181217 comento
Call oAcceso.CargaControles(gsDominio, MatUser, MatGrupo, RsMenu, rsOpe, gsCodUser, rsOpcEsp, rsCargos, 6) 'AMDO 20130726, Se agrego RsOpcEsp,RsCargos 'marg20181217 agrego
'*************END AMDO
...
'            Me.cmdagregar.Enabled = False
        End If
        'Call oAcceso.CargaMenu(gsDominio, LstGrupos.SelectedItem.Text, "2", , , 0) 'marg20181217 comento
        Call oAcceso.CargaMenu(gsDominio, LstGrupos.SelectedItem.Text, "2", , , 6) 'marg20181217 agrego
        sCadMenu = oAcceso.sCadMenu
...
'            Me.cmdagregar.Enabled = True
        ...
        'Call oAcceso.CargaMenu(gsDominio, LstUsuarios.SelectedItem.Text, "1", , gdFecSis, 0) 'marg20181217 comento
        Call oAcceso.CargaMenu(gsDominio, LstUsuarios.SelectedItem.Text, "1", , gdFecSis, 6) 'marg20181217 agrego
        'END MADM
        sCadMenu = oAcceso.sCadMenu
        sCadMenuGrp = oAcceso.sCadMenuGrp
                ...
                If Not Node.Checked Then
                    If IsDate(txtFecha) Then
                        If (txtFecha >= gdFecSis) Then
                            'Call oAcceso.OtorgarOperacion(sUsuario, Node.Tag, sTipoUsu, CDate(Me.txtFecha.Text), 0) 'marg20181217 comento
                            Call oAcceso.OtorgarOperacion(sUsuario, Node.Tag, sTipoUsu, CDate(Me.txtFecha.Text), 6) 'marg20181217 agrego
                        Else
                            MsgBox "La fecha ingresada debe ser Mayor o Igual a la del Sistema", vbInformation, "Aviso"
                            Exit Sub
                        End If
                    Else
                        'Call oAcceso.OtorgarOperacion(sUsuario, Node.Tag, sTipoUsu, , 0) 'marg20181217 comento
                        Call oAcceso.OtorgarOperacion(sUsuario, Node.Tag, sTipoUsu, , 6) 'marg20181217 agrego
                    End If
                    'Call oAcceso.OtorgarAcceso(sUsuario, Node.Tag, sTipoUsu)
                    Node.Checked = True
                End If
            Else
                'Call oAcceso.DenegarAcceso(sUsuario, Node.Tag, sTipoUsu, 0) 'marg20181712 comento
                Call oAcceso.DenegarAcceso(sUsuario, Node.Tag, sTipoUsu, 6) 'marg20181712 agrego
                Node.Checked = False
            End If
        End If
...
Dim sUsuario As String
        ...
        If UCase(Node.Text) <> "MENU" Then
            If bChecked = True Then
                ...
                End If
            Else
                'Call oAcceso.DenegarOperacion(sUsuario, Node.Tag, sTipoUsu, 0) 'marg20181217 comento
                Call oAcceso.DenegarOperacion(sUsuario, Node.Tag, sTipoUsu, 6) 'marg20181217 agrego
                Node.Checked = False
            End If
        End If
        If oAcceso.vError Then
            ...
            If Node.Checked = True Then
              If IsDate(txtFecha) Then
                    If (txtFecha >= gdFecSis) Then
                        ...
                        'Call oAcceso.OtorgarAcceso(sUsuario, Node.Tag, sTipoUsu, CDate(Me.txtFecha.Text), 0) 'WIOR 20130913 'COMENTO 'marg20181217 comento
                        Call oAcceso.OtorgarAcceso(sUsuario, Node.Tag, sTipoUsu, CDate(Me.txtFecha.Text), 6) 'marg20181217 agrego
                        '***Agregado por ELRO el 20111130, según Acta 324-2011/TI-D
                ...
                Else
                    ...
                    'Call oAcceso.OtorgarAcceso(sUsuario, Node.Tag, sTipoUsu, , 0) 'WIOR 20130913 'marg20181217 comento
                    Call oAcceso.OtorgarAcceso(sUsuario, Node.Tag, sTipoUsu, , 6) 'WIOR 20130913 'marg20181217 agrego
                    '***Agregado por ELRO el 20111130, según Acta 324-2011/TI-D
                    Set oNCOMContFunciones = New COMNContabilidad.NCOMContFunciones
                    lsMovNro = oNCOMContFunciones.GeneraMovNro(gdFecSis, gsCodAge, gsCodUser)
                    Call oPista.InsertarPista(gsOpeCod, lsMovNro, gsCodPersUser, GetMaquinaUsuario, "1", "Otorga Permiso a " & IIf(sTipoUsu = "1", "USUARIO " & UCase(sUsuario), UCase(sUsuario)) & " la opción " & CStr(Node.Tag) & " - " & Replace(Node.Text, "&", "") & " cuya ruta es " & Replace(CStr(Node.FullPath), "&", ""))
                ...
                End If
            Else
                'Call oAcceso.DenegarAcceso(sUsuario, Node.Tag, sTipoUsu, 0) 'marg20181217 comento
                Call oAcceso.DenegarAcceso(sUsuario, Node.Tag, sTipoUsu, 6) 'marg20181217 agrego
                '***Agregado por ELRO el 20111130, según Acta 324-2011/TI-D
                Set oNCOMContFunciones = New COMNContabilidad.NCOMContFunciones
                lsMovNro = oNCOMContFunciones.GeneraMovNro(gdFecSis, gsCodAge, gsCodUser)
        ...
        If UCase(Node.Text) <> "MENU" Then
            ...
            Else
                ...
                If SSTabOpc.Tab = 0 Then
                    Call oAcceso.DenegarOperacion(sUsuario, Mid(Node.Tag, 1, 3) & "0000000000", sTipoUsu, 0)
                    '***Agregado por ELRO el 20111130, según Acta 324-2011/TI-D
                    Set oNCOMContFunciones = New COMNContabilidad.NCOMContFunciones
                    lsMovNro = oNCOMContFunciones.GeneraMovNro(gdFecSis, gsCodAge, gsCodUser)
                    Call oPista.InsertarPista(gsOpeCod, lsMovNro, gsCodPersUser, GetMaquinaUsuario, "3", "Denegar Permiso a " & IIf(sTipoUsu = "1", "USUARIO " & UCase(sUsuario), UCase(sUsuario)) & " la operación " & Node.Text & " cuya ruta es " & Replace(CStr(Node.FullPath), "&", ""))
                    ...
                    If Not NodeTemp Is Nothing Then
                        Do
                            NodeTemp.Checked = False
                            Call oAcceso.DenegarOperacion(sUsuario, NodeTemp.Tag, sTipoUsu, 0)
                            '***Agregado por ELRO el 20111130, según Acta 324-2011/TI-D
                            Set oNCOMContFunciones = New COMNContabilidad.NCOMContFunciones
                            lsMovNro = oNCOMContFunciones.GeneraMovNro(gdFecSis, gsCodAge, gsCodUser)
                            Call oPista.InsertarPista(gsOpeCod, lsMovNro, gsCodPersUser, GetMaquinaUsuario, "3", "Denegar Permiso a " & IIf(sTipoUsu = "1", "USUARIO " & UCase(sUsuario), UCase(sUsuario)) & " la operación " & Node.Text & " cuya ruta es " & Replace(CStr(Node.FullPath), "&", ""))
