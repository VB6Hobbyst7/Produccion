...
'Call oAcceso.CargaControlesMantResponsabilidades(gsDominio, MatUser, MatGrupo, RsMenu, rsOpe, 1) 'marg20181217 comento
Call oAcceso.CargaControlesMantResponsabilidades(gsDominio, MatUser, MatGrupo, RsMenu, rsOpe, 6) 'marg20181217 agrego
        ...
        If UCase(Node.Text) <> "MENU" Then
            If bChecked = True Then
                If Not Node.Checked Then
                    'Call oAcceso.OtorgarAcceso(sUsuario, Node.Tag, sTipoUsu, , 1) 'marg20181217 comento
                    Call oAcceso.OtorgarAcceso(sUsuario, Node.Tag, sTipoUsu, , 6) 'marg20181217 agrego
                    Node.Checked = True
                End If
            Else
                'Call oAcceso.DenegarAcceso(sUsuario, Node.Tag, sTipoUsu, 1) 'marg20181217 comento
