...
Begin VB.MDIForm MDISicmact 
   ...
   Begin VB.Menu M0200000000 
      ...
      Begin VB.Menu M0201000000 
         ...
         Begin VB.Menu M0201080000 
            Caption         =   "Sorteo General"
            Index           =   1
            Begin VB.Menu M0201080001 
               Caption         =   "PREPARAR "
               Index           =   0
            End
            Begin VB.Menu M0201080001 
         ...
         End
         Begin VB.Menu M0201080000 
            Caption         =   "Sorteo de Agencia"
            Index           =   2
            Begin VB.Menu M0201080002 
               Caption         =   "PREPARAR"
               Index           =   0
            End
            Begin VB.Menu M0201080002 
      ...
      End
      Begin VB.Menu M0201000000 
         Caption         =   "Cuentas con Convenio"
         Index           =   17
         Begin VB.Menu M0201120000 
            Caption         =   "Registro Personas con Convenio"
            Index           =   0
         End
         Begin VB.Menu M0201120000 
            Caption         =   "Comision de Cuentas con Convenio"
            Index           =   2
         End
      End
   End
   Begin VB.Menu M0300000000 
      ...
      Begin VB.Menu M0301000000 
         ...
         End
         Begin VB.Menu M0301020000 
            Caption         =   "Credito con Ampliacion"
            Index           =   26
         End
      End
      Begin VB.Menu M0301000000 
   ...
   Begin VB.Menu M0800000000 
      ...
      End
      Begin VB.Menu M0801000000 
         Caption         =   "Control de Calidad SICMACI-SIAFC"
         Index           =   4
      End
      Begin VB.Menu M0801000000 
         Caption         =   "Migracion de Calendarios SIMACI-SIAF"
         Index           =   5
      End
   End
...
'    Case 2
'        frmPreparaSorteo.Inicia ("NN")
'
'  End Select
End Sub

Private Sub M0201080001_Click(Index As Integer)
  Select Case Index
    Case 0
        frmPreparaSorteo.Inicia ("00")
...
Private Sub M0201080002_Click(Index As Integer)
Select Case Index
    Case 0
        frmPreparaSorteo.Inicia ("NN")
        
    Case 1
        frmConsolidaSorteo.Inicia ("NN")
  End Select
End Sub
