...
Global Const cPlantillaActaRema = "\FormatoCarta\ActaRemate.txt"
...
'***Tasa de Credito Pignoraticio a Cliente por Mala Calificación
'***Agregado por ELRO el 20120120, según Acta N° 002-2012/TI-D
Global Const gnTasaIntCrePigCliMalCal = "10" '7.3 Tasa de interes compensatorio
Global Const gnTasaIntVencidoCrePigCliMalCal = "10" '7.3 Tasa de interes compensatorio vencido
