VERSION 5.00
Begin VB.Form frmColPPagoSobranteRemate 
   ...
   ClientTop       =   1845
   ClientWidth     =   7995
   Icon            =   "frmColPPagoSobranteRemate.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmColPPagoSobranteRemate"
...
Dim lsmensaje As String
Dim lnMovNroPgoSobRemate As Long
...
'*** PEAC 20091207 - visto electronico ******************************************************
...
Set loVistoElectronico = New frmVistoElectronico
    ...
    lbResultadoVisto = loVistoElectronico.Inicio(3, "122200")
    ...
    If MsgBox("Está seguro de retirar Sobrante de Remate ? ", vbYesNo + vbQuestion + vbDefaultButton1, " Aviso ") = vbYes Then
        ...
        Set loGrabarVta = New COMNColoCPig.NCOMColPContrato
            ...
            Call loGrabarVta.nPagoSobranteRemate(AXCodCta.NroCuenta, fsVarNroRemate, lsFechaHoraGrab, _
                 lsMovNro, CCur(lblSobrante.Caption), lsCtaSobranteRemate, sLpt, False, , lnMovNroPgoSobRemate)
        Set loGrabarVta = Nothing

        '*** PEAC 20091207
            loVistoElectronico.RegistraVistoElectronico (lnMovNroPgoSobRemate)
        '*** FIN PEAC
