...
Begin VB.Form frmCredFormEvalFormato5 
   ...
   Begin TabDlg.SSTab SSTabRatios 
      ...
      Tab(0).Control(1)=   "Label19(2)"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "Label32"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "Label33"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "Label19(3)"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "Label19(4)"
      ...
      Tab(1).Control(2)=   "Label13(5)"
      Tab(1).Control(3)=   "Label13(6)"
      Tab(1).Control(4)=   "Label13(7)"
      Tab(1).Control(5)=   "Label29"
      Tab(1).Control(6)=   "Label28"
      Tab(1).Control(7)=   "Label22"
      Tab(1).Control(8)=   "Label21"
      Tab(1).Control(9)=   "Label34"
      Tab(1).Control(10)=   "Label13(8)"
      Tab(1).Control(11)=   "Label13(9)"
      Tab(1).Control(12)=   "Label13(10)"
      Tab(1).Control(13)=   "Label13(11)"
      Tab(1).Control(14)=   "Label13(12)"
      Tab(1).Control(15)=   "EditMoneyForm5IC"
      Tab(1).Control(16)=   "EditMoneyForm5IGV"
      Tab(1).Control(17)=   "EditMoneyForm5IPP"
      Tab(1).Control(18)=   "EditMoneyForm5ICM"
      Tab(1).Control(19)=   "EditMoneyForm5IVC"
   ...
   Begin TabDlg.SSTab SSTabInfoNego 
      ...
      TabPicture(0)   =   "frmCredFormEvalFormato5.frx":0342
      Tab(0).ControlEnabled=   -1  'True
   ...
   Begin TabDlg.SSTab SSTabIngresos5 
      ...
      TabPicture(0)   =   "frmCredFormEvalFormato5.frx":035E
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame5"
      Tab(0).Control(1)=   "Frame3"
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "Evaluación"
      TabPicture(1)   =   "frmCredFormEvalFormato5.frx":037A
      Tab(1).ControlEnabled=   0   'False
      ...
      TabPicture(2)   =   "frmCredFormEvalFormato5.frx":0396
      Tab(2).ControlEnabled=   -1  'True
      Tab(2).Control(0)=   "framePropuesta"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Comentarios y Referidos"
      TabPicture(3)   =   "frmCredFormEvalFormato5.frx":03B2
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "frameComentario"
      Tab(3).Control(1)=   "frameReferido"
...
Private Sub feFlujoCajaMensual_OnClickTxtBuscar(psMontoIfiGastoNego As String, psDescripcion As String) 'Fujo Caja Mensual
    ...
    If psMontoIfiGastoNego = 0 Then
        ...
        frmCredFormEvalCuotasIfis.Inicio (CLng(feFlujoCajaMensual.TextMatrix(feFlujoCajaMensual.row, 4))), fnTotalRefGastoNego, MatIfiGastoNego
...
On Error GoTo ErrorCargaDatos
    ...
    CargaDatos = oNCOMFormatosEval.CargaDatosCredEvaluacion2(sCtaCod, _
                                                            ...
                                                            rsDatPDTDet, _
                                                            gFormatoActivos, _
                                                            gFormatoPasivos, rsDatParamFlujoCajaForm5)
