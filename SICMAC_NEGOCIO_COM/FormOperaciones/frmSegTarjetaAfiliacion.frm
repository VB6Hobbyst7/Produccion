...
lblUsuTarjeta.Caption = user.UserNom
'*****************************************
Me.Show 1
End Sub
...
'CTI2 FERIMORO : ERS034-2019 11/11/2020
...
If chkActivar.value = 1 Then
  txtUsuario.Enabled = True
  txtUsuario.Text = ""
  lblUsuTarjeta.Caption = ""
  txtUsuario.SetFocus
Else
    txtUsuario.Text = gsCodUser
...
'    End If
    ...
    'CTI2 FERIMORO ERS034-2019   31082020
    If (chkActivar.value = 1 And txtUsuario.Text = "" And lblUsuTarjeta.Caption = "") Or (Len(txtUsuario) < 4) Then
           MsgBox "Debe agregar el Usuario Promotor del Seguro", vbInformation, "Alerta SICMAC"
           txtUsuario.SetFocus
           Exit Sub
    End If
    Set oDSegTar = Nothing
...
Private Sub txtUsuario_Change()
    ...
    user.Inicio txtUsuario
    lblUsuTarjeta = user.UserNom
