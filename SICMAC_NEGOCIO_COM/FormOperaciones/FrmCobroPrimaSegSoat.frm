...
'CTI2 FERIMORO : ANEXO1 ERS034-2019
...
If Not oPersona Is Nothing Then
    ...
    'CTI2 FERIMORO : ANEXO1 ERS034-2019
    '************************************************
    tpoDoc = Trim(oSegSoat.BuscaTpoDoc(lsPersCod))
    
    Select Case tpoDoc
        Case "DNI":
            txtdoi.Text = oPersona.sPersIdnroDNI
        Case "RUC":
            txtdoi.Text = oPersona.sPersIdnroRUC
        Case "CARNET DE EXTRANJERIA":
            txtdoi.Text = oPersona.sPersIdnroOtro
        Case Else
            MsgBox "El cliente no cuenta con Tipo de Documento adecuado, por favor verifique", vbInformation, "Aviso"
            Call cmdLimpiar_Click
            Exit Sub
    End Select
        
    cmbTipoDoi.AddItem Trim(tpoDoc)
...
Dim bExisteF As Integer
   ...
   'ANDE 20180228 Comprobar si tiene acceso la opción como RFIII
    ...
    End If
    'CTI2 FERIMORO: 11/02/2021 - CORRIGE ERROR DE USUARIOS
    'If txtBuscarUser = "" Then txtBuscarUser.SetFocus: MsgBox "Debe Registrar el Usuario", vbInformation, "Aviso": Exit Sub
    If txtBuscarUser = "" Or lblDescUser.Caption = "" Then txtBuscarUser.SetFocus: MsgBox "Debe Registrar el Usuario", vbInformation, "Aviso": Exit Sub
    '**************************************************************
