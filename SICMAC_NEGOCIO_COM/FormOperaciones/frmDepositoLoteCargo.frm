...
Begin VB.Form frmCapDepositoLoteCargo 
   Caption         =   "Deposito en Lote con Cargo y Abono en cuenta"
   ClientHeight    =   7890
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   13230
   Icon            =   "frmDepositoLoteCargo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7890
   ...
   End
End
Attribute VB_Name = "frmCapDepositoLoteCargo"
...
If sError <> "" Then
    ...
    Set oPrevio = New previo.clsprevio
        oPrevio.Show sError, "Errores Cargo Abono en Lote", True
    Set oPrevio = Nothing
    cmdCancelar_Click
    Exit Sub
End If
...
Dim MatCalend As Variant
    ...
    Set R = oDCaptacion.ObtenerCtasParaDepositoEnLote(lsPersCodCargo, Trim(Mid(txtCuenta.Cuenta, 1, 1)))
...
If MsgBox("¿Está seguro de grabar la información?", vbQuestion + vbYesNo, "Aviso") = vbYes Then
    ...
    Dim nMontoLavDinero As Double, nTC As Double ', sReaPersLavDinero As String, sBenPersLavDinero As String COMENTADO X JACA 20110225
    ...
    'If clsLav.EsOperacionEfectivo(Trim(nOperacion)) Then
        ...
        If Not clsExo.EsCuentaExoneradaLavadoDinero(sCuenta) Then
            ...
            If nMontoCargo >= Round(nMontoLavDinero * nTC, 2) Then
                'JACA 20110225
                    sPersLavDinero = IniciaLavDinero(loLavDinero) 'JACA 20110225
...
'Private Function IniciaLavDinero() As String COMENTADO X JACA 20110225
Private Function IniciaLavDinero(ByVal loLavDinero As frmMovLavDinero)   'JACA 20110225
Dim i As Long
...
Set rsPersona = oDatos.dDatosPersonas(sPersCod)
  ...
  IniciaLavDinero = loLavDinero.inicia(sPersCod, sNombre, sDireccion, sDocId, True, True, nMonto, sCuenta, "TRANSFERENCIA AHORROS", , sTipoCuenta, , , , , , , gnTipoREU, gnMontoAcumulado, gsOrigen)
  '*************************************************************************************************************
Set oDatos = Nothing
'End If
End Function
