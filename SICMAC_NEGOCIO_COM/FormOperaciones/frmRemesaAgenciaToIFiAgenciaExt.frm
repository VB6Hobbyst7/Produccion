   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame frmMotExtorno 
         ...
         Begin VB.ComboBox cmbMotivos 
            BackColor       =   &H00C0FFC0&
            Height          =   315
            ItemData        =   "frmRemesaAgenciaToIFiAgenciaExt.frx":030A
            Left            =   240
            List            =   "frmRemesaAgenciaToIFiAgenciaExt.frx":0317
...
'    End If
    ...
    lbExito = oCaja.ExtornarRemesa(Datos, gdFecSis, Right(gsCodAge, 2), gsCodUser, gsOpeCod, Trim(txtGlosa.Text), DatosExtorna)
